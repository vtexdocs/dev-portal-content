...
The `Shopping Assistant` section is available on all store pages, so it should be added to the [Global Sections Content Type](https://developers.vtex.com/docs/guides/faststore/headless-cms-overview#content-types).
