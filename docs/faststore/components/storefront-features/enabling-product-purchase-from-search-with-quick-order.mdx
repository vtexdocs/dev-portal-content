...
- [VTEX Intelligent Search](https://help.vtex.com/en/docs/tracks/vtex-intelligent-search) installed and integrated with your store.
- An understanding of [Section Override](https://developers.vtex.com/docs/guides/faststore/overrides-overview) to follow along the instructions.
