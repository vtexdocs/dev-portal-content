...
In this guide, you'll learn how to extend the [My Account](https://developers.vtex.com/docs/guides/faststore/my-account-overview) page in your B2B store by creating new pages or adding new sections to the default pages.
...
> ⚠️ All My Account routes are private and must include the `/pvt/account` prefix. Custom routes are validated to ensure this prefix is included, but you should declare it.
