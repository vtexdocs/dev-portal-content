...
> ⚠️ All My Account routes are private and must include the `/pvt` prefix. Custom routes are validated to ensure this prefix is included, but you should declare it.
