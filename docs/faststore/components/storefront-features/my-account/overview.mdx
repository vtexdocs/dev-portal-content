...
Make sure you're using the latest version of `@faststore/cli`.  If the version isn't updated, see [Updating the `@faststore/cli` package version](https://developers.vtex.com/docs/guides/faststore/project-structure-updating-the-cli-package-version).
