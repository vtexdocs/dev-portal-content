...
The orders page features filtering capabilities that enable users to locate specific orders quickly. By default, the following filter options are available:
