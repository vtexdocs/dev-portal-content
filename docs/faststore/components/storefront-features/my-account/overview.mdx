...
- **Configure Shopper entity access**: Enable access to Shopper information (such as the "Ordered by" card and shopper filters) by following the guide [Configuring Shopper entity access](https://developers.vtex.com/docs/guides/faststore/my-account-configuring-shopper-entity-access).