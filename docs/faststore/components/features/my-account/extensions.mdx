...
In this guide, you'll learn how to extend the **My Account** page in your B2B store by either creating new pages or adding new sections to the default pages.
