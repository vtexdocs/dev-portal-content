...
Now that you have the experimental **My Account** enabled in your project, you can extend this feature by following the guide [Extending My Account](https://developers.vtex.com/docs/guides/faststore/features-my-account-extensions).
