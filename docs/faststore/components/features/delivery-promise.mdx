...
`Region Popover` is a section that manages user location inputs. It's composed of other components, such as [`Popover`](https://developers.vtex.com/docs/guides/faststore/molecules-popover), [`InputField`](https://developers.vtex.com/docs/guides/faststore/molecules-input-field), [`Icon`](https://developers.vtex.com/docs/guides/faststore/atoms-icon, and [`Link`](https://developers.vtex.com/docs/guides/faststore/atoms-link).
