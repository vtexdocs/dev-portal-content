...
<SectionList grid="column" columns={2}>
  <SectionItem
    ...
    actionPath="/docs/faststore/molecules-search-history"
  >
  ...
  <SectionItem
    ...
    actionPath="/docs/faststore/molecules-search-top"
  >
  ...
  <SectionItem
    ...
    actionPath="/docs/faststore/molecules-search-auto-complete"
  >
    <SearchAutoComplete>
  ...
  <SectionItem
    ...
    actionPath="/docs/faststore/molecules-search-products"
  >
    <SearchProducts>
  ...
  <SectionItem
    ...
    actionPath="/docs/faststore/molecules-search-dropdown"
    containerStyle={{
      alignItems: 'start',
    }}
  >
  ...
  <SectionItem
    ...
    actionPath="/docs/faststore/molecules-search-input-field"
  >
  ...
  <SectionItem
    ...
    actionPath="/docs/faststore/organisms-search-input"
    containerStyle={{
      alignItems: 'start',
    }}
  >
