...
This filter displays available products according to the shopper's location. With this option, shoppers can filter by using the following options:
...
| **Express**  | Displays products eligible for fast delivery, in less than 1 hour. |
