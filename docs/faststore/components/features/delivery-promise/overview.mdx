...
To create, configure, and manage delivery options in the VTEX Admin, see the instructions in the [Delivery Options (Beta)](https://newhelp.vtex.com/docs/tutorials/delivery-options-beta) guide.
