...
In PLPs or search pages, the shopper have the following options to apply filters: [Delivery Methods](#delivery-methods-filters) and [Delivery Option](delivery-option-filters).

#### Delivery Methods filters

Displays available products according to the shopper's location. In this option, shoppers can filter by the following filters:
...
| ----------------- | --------------- |
| **All delivery methods** | Displays products that match all of the active delivery method filters, **Shipping to**, **Pickup anywhere**, **Pickup at**, **Pickup nearby**. |
