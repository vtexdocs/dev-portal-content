...
In PLPs or search pages, the shopper has the following options to apply filters: [Delivery Methods](#delivery-methods-filters) and [Delivery Option](#delivery-option-filters).

#### Delivery Methods filters

Displays available products according to the shopper's location. In this option, shoppers can filter using the following options:
...
In the following table see the available type of badges:
