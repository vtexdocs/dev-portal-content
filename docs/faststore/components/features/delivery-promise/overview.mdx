...
| ---------- | ----------- |
| Available for delivery | Indicates whether the product can be shipped to the shopper's postcode. |
| Unavailable for pickup | Indicates that the product cannot be collected from a nearby pickup point. |
