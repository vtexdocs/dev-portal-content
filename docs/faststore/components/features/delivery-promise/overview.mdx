...
updatedAt: "2026-07-27T18:35:51.192Z"
---
...
* [`useDeliveryPromise_unstable`](https://developers.vtex.com/docs/guides/faststore/developing-and-customizing-components-experimental-exports-hooks-and-components#list-of-hooks-and-components): Manages all logic for querying, displaying, and updating delivery availability filters and states.
* [`deliveryPromiseStore_unstable`](https://developers.vtex.com/docs/guides/faststore/developing-and-customizing-components-experimental-exports-hooks-and-components#list-of-hooks-and-components): Stores and retrieves Delivery Promise data (pickup points, default/global selection, simulation state).
...
![filter-by-store](https://vtexhelp.vtexassets.com/assets/docs/src/dp-new-filter-by-store___45ee62209fa8bca8a13431615ab2c4e4.gif)

### PLP or search page filters

On PLPs or search pages, shoppers have the following options for applying filters: [Delivery Methods](#delivery-methods-filters), [Delivery Option](#delivery-option-filters), and [Availability](#availability).
...
![sla-filter](https://vtexhelp.vtexassets.com/assets/docs/src/dp-sla-filter___35a00e0ed883cb9ce23cdb08dffd51ad.gif)
*/}

#### Delivery Methods

This filter displays available products according to the shopper's location, allowing them to filter using the following options:
...
![dp-delivery-options](https://vtexhelp.vtexassets.com/assets/docs/src/dp-delivery-option-overview___ae1889d1ab384af14049ee26a887faa2.png)
...
This filter helps shoppers refine product results based on whether items are available for purchase and fulfillment, preventing the display of products they can't immediately buy in their preferred fulfillment method and narrowing results to only what’s actually in stock.
