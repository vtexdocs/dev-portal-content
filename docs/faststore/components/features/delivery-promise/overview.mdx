...
>⚠️ To edit the filters labels, follow the instructions on [Managing filters and badges](https://developers.vtex.com/docs/guides/faststore/delivery-promise-implementation).
...
| **Pickup in 1 hour** | Displays products available for pickup 1 hour. |
...
>⚠️ To edit the badges labels or unable the badges, follow the instructions on [Managing filters and badges](https://developers.vtex.com/docs/guides/faststore/delivery-promise-implementation).
