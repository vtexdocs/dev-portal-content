...
>ℹ️ For more details on filters and badges, see the [Understanding Delivery Promise operation](https://developers.vtex.com/docs/guides/faststore/delivery-promise-components) guide.
