...
By default, badges are already active once Delivery Promise is implemented in the store. However, you can edit their labels. To do this, follow the next sections.
