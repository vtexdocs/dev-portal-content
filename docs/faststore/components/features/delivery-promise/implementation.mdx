...
By default, filters and badges are active once Delivery Promise is implemented in the store. However, you can deactivate them (Global filter by pickup point, Delivery Option, and Badges) and edit their labels in the Headless CMS. To do this, follow these steps.
