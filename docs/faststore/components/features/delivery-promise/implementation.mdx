...
* `mandatory`: When set to **false**, providing a postal code is optional for the user. Users can browse and add items to the cart without entering their postal code. Although the accuracy of delivery information may be limited.
...
By default, badges are already activated once Delivery Promise is implemented in the store. However, you can edit their labels. To do this, follow the next sections.
