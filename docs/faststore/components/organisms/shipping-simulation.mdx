...
excerpt: Shipping Simulation are sliders that allows users to select a maximum and minimum price.
...
---
This component lets customers set the `PostalCode` and see the shipping options in the `PDP`.## Import
