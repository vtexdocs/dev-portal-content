---
title: SKUMatrix
excerpt: Open and close the slider, control the state of the SKUs by changing the quantity of items to be added to the cart and returning the list of product variations
