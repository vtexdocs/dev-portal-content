...
The `SearchInput` is responsible to receive, search and display suggestions. This component is part of the [Search](https://developers.vtex.com/docs/guides/faststore/feature-search) feature.
