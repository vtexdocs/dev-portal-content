---
title: "Price Range"
excerpt: "The Price Range component is a Slider that allows users to select a maximum and minimum price from a range."
...
<ComponentPropsSection name="PriceRange" />
