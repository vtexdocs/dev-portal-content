---
title: "Product Grid"
excerpt: It's a section generally used on PLP pages to list the products available in the store.
...
We highly recommend using the [ProductCard](/docs/guides/faststore/molecules-product-card) as the direct child of the `ProductGridItem`.
