...
[<i class="fa-brands fa-github"></i> Source code](https://github.com/vtex/faststore/tree/main/packages/components/src/organisms/Newsletter)
...
You can target and override `Newsletter` styles using the following data attributes:
