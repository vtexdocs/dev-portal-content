...
We highly recommend using the [ProductCard](/docs/guides/faststore/molecules-product-card) as the direct child of the `ProductShelfItem`.
...
You can use [ProductCard variants](/docs/guides/faststore/molecules-product-card#variants) to create `ProductShelf` variations.
...
### With [Carousel](/docs/guides/faststore/molecules-carousel)
...
- We don't recommend using [Carousel](/docs/guides/faststore/molecules-carousel) inside `ProductShelf` when display 5 or less items.
...
See [Carousel Code Example](/docs/guides/faststore/organisms-product-shelf#with-carousel)
