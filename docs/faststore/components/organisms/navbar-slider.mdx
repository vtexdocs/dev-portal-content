...
As part of the [Navbar](/docs/guides/faststore/organisms-navbar), this component is its **mobile version** used to list the navigation links (through the [NavbarLinks](/docs/guides/faststore/molecules-navbar-links)).
