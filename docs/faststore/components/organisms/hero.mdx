...
[<i class="fa-brands fa-github"></i> Source code](https://github.com/vtex/faststore/tree/main/packages/components/src/organisms/Hero)
...
You can target and override `Hero` styles using the following data attributes:
