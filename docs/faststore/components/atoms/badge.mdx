...
[Code source](https://github.com/vtex/faststore/tree/main/packages/components/src/atoms/Badge)
...
Warning badges uses and orange or yellow palette to signal caution, pending actions, or non-critical alerts.
