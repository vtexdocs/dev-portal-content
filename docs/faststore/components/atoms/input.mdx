...
- Provide a [Label](/docs/faststore/atoms-label) when using input. Descriptive labels help users understand the purpose of a form control.
...
InputField wraps an Input and its corresponding Label."
    actionPath="/docs/faststore/molecules-input-field"
  >
