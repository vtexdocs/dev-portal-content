...
<Tabs items={['Example', 'Code']} defaultIndex="0">
  ...
  <Tab>
    ...
    export default function Component() {
      return <Link inverse={true}>Inverse Link</Link>
    }
    ```
  </Tab>
</Tabs>
...
<Tabs items={['Example', 'Code']} defaultIndex="0">
  ...
  <Tab>
    ...
    export default function Component() {
      return <Link variant="display">Display Link</Link>
    }
    ```
  </Tab>
</Tabs>
...
<Tabs items={['Example', 'Code']} defaultIndex="0">
  ...
  <Tab>
    ...
    export default function Component() {
      return <Link variant="inline">Inline Link</Link>
    }
    ```
  </Tab>
</Tabs>
...
<Tabs items={['Example', 'Code']} defaultIndex="0">
  ...
  <Tab>
    ...
    export default function Component() {
      return <Link size="small">Small Link</Link>
    }
    ```
  </Tab>
</Tabs>
