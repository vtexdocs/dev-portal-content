...
The `Checkbox` component provides accessible markup, design tokens for customization, and states for `checked`, `unchecked`, `disabled`, and partially (`partial`) checked usage.
