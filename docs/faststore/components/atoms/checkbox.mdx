...
- Provide a [Label](https://developers.vtex.com/docs/guides/faststore/atoms-label) when using checkbox input. Descriptive labels help users understand the purpose of a form control.
