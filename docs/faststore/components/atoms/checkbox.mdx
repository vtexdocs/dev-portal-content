...
- Provide a [Label](/docs/faststore/atoms-label) when using checkbox input. Descriptive labels help users understand the purpose of a form control.
...
<SectionList>
  <SectionItem
    ...
    actionPath="/docs/faststore/molecules-checkbox-field"
  >
