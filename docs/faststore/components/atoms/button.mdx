...
- Call-to-action buttons on [Cards](https://developers.vtex.com/docs/guides/faststore/organisms-card)
- Submit and/or withdraw actions on [Forms](https://developers.vtex.com/docs/guides/faststore/molecules-form)
