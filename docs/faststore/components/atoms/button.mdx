...
Buttons indicate faststore actions that users can take, such as adding an item to the cart, submitting a form, and proceeding with an operation.
...
- `Buy now` and `Add to cart` buttons on [Product Cards](https://developers.vtex.com/docs/guides/faststore/molecules-product-card).
- Submit and/or withdraw actions on [Modal](https://developers.vtex.com/docs/guides/faststore/molecules-modal) windows.
