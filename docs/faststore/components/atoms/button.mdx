---
title: "Button"
excerpt: "Buttons indicate actions that users can take, such as adding an item to the cart, submitting a form, and proceeding with an operation."
...
- Buy-now and add-to-cart buttons on [Product Cards](/docs/faststore/molecules-product-card)
- Call-to-action buttons on Cards
- Submit and/or withdraw actions on Forms
- Submit and/or withdraw actions on [Modal](/docs/faststore/molecules-modal) windows.
...
- Don't place buttons next to [Badges](/docs/faststore/atoms-badge). Although badges and buttons are similar in appearance, badges are not interactive and may confuse users if not used in the proper context.
- Don't use Buttons as [Links](/docs/faststore/atoms-link). Links are not intended to invite users to take action. Instead, they redirect users somewhere.
...
<SectionList grid="row">
  <SectionItem
    ...
    actionPath="/docs/faststore/molecules-icon-button"
  >
  ...
  <SectionItem
    ...
    actionPath="/docs/faststore/molecules-buy-button"
  >
  ...
  <SectionItem
    ...
    actionPath="/docs/faststore/molecules-link-button"
  >
