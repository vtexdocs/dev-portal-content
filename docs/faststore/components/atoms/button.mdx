...
- Buy-now and add-to-cart buttons on [Product Cards](/docs/guides/faststore/molecules-product-card)
- Call-to-action buttons on [Cards](/docs/guides/faststore/organisms-card)
- Submit and/or withdraw actions on [Forms](/docs/guides/faststore/molecules-form)
- Submit and/or withdraw actions on [Modal](/docs/guides/faststore/molecules-modal) windows.
...
- Don't place buttons next to [Badges](/docs/guides/faststore/atoms-badge). Although badges and buttons are similar in appearance, badges are not interactive and may confuse users if not used in the proper context.
- Don't use Buttons as [Links](/docs/guides/faststore/atoms-link). Links are not intended to invite users to take action. Instead, they redirect users somewhere.
