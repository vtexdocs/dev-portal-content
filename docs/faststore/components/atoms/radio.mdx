...
<ComponentPropsSection name="Radio" />
...
- Provide a [Label](/docs/faststore/atoms-label) when using radio input. Descriptive labels help users understand the purpose of a form control.
...
RadioField wraps a Radio input and its corresponding Label."
    actionPath="/docs/faststore/molecules-radio-field"
  >
