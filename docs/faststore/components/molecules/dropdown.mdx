---
title: "Dropdown"
excerpt: "Displays a set of actions/items to the user, usually used to show a menu of options."
...
<ComponentPropsSection name="Dropdown" />

### DropdownItem

<ComponentPropsSection name="DropdownItem" />

### DropdownMenu

<ComponentPropsSection name="DropdownMenu" />

### DropdownButton

<ComponentPropsSection name="DropdownButton" />
