...
excerpt: "A custom `Badge` that display product's discounts."
...
This component inherits [Badge](/docs/faststore/atoms-badge) design tokens.
...
This component inherits [Badge](/docs/faststore/atoms-badge) css selectors and styles.
