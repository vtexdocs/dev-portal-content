...
excerpt: "List of `SearchProductItem` to show details of the suggested products. This component is part of the Search feature."
...
<ComponentPropsSection propsList={propsPriceDefinition} />
