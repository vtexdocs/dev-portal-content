---
title: "Sku Selector"
excerpt: "The `SkuSelector` component is mainly used in Product Details Pages (PDPs) to display all the available variants for a given product."
...
<ComponentPropsSection propsList={propsSkuOptions} />
