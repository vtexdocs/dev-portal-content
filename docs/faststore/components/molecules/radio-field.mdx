---
title: "Radio Field"
excerpt: RadioField grouped a Radio input and its corresponding Label.
...
Radio Field wraps a [Radio](/docs/guides/faststore/atoms-radio) input and its corresponding [Label](/componentes/atoms/label). It allows users to select one option from a set.
