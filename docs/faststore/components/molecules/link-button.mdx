...
Besides those attributes, the following props are also supported [Button Props](/docs/guides/faststore/atoms-button#props):
...
This component inherits [Button](/docs/guides/faststore/atoms-button) design tokens.
...
This component inherits [Button](/docs/guides/faststore/atoms-button) variants.
...
- Use the `LinkButton` only to navigate the user between store pages. For general purposes, use the standard [Button](/docs/guides/faststore/atoms-button).
