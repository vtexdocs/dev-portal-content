---
title: "Navbar Links"
excerpt: "A wrapper used to display a set of navigation links that self adapts on mobile or desktop screens. This component is part of the Navigation feature and must be used in the Navbar context."
...
>⚠️ The mobile version can be achieved with [NavbarSlider](/docs/faststore/organisms-navbar-slider) as wrapper.
...
<SectionList grid="column" columns={1}>
  <SectionItem
    ...
    actionPath="/docs/faststore/organisms-navbar"
  >
    <UIProvider>
      <NavbarUsage />
    </UIProvider>
  ...
  <SectionItem
    ...
    actionPath="/docs/faststore/organisms-navbar-slider"
  >
    <UIProvider>
      <NavbarSliderUsage />
    </UIProvider>
