...
This component is part of the [Navigation](https://developers.vtex.com/docs/guides/faststore//feature-navigation) feature and must be used in the [Navbar](https://developers.vtex.com/docs/guides/faststore/organisms-navbar) context.## Import
