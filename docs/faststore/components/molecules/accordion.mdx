---
title: "Accordion"
excerpt: Accordions display an expandable/collapsible list of items.
...
Accordions display an expandable/collapsible list of items. The final Accordion component is a compound of the following:- `Accordion`: wraps a series of `AccordionItem`s in a single component.
...
<Tabs items={['Example', 'Code']} defaultIndex="0">
  <Tab>
    <OverviewSection><AccordionUsage/></OverviewSection>
  </Tab>
  <Tab>
    ```tsx
...
All accordion-related components support all attributes also supported by the `<div>` tag, except for the `AccordionButton`, which renders the `<button>` tag and inherits [Button](/docs/guides/faststore/atoms-button) props.
...
<ComponentPropsSection propsList={propsAccordionItem} />
...
The `AccordionButton` component inherits [Button](/docs/guides/faststore/atoms-button) CSS selectors.
...
<Tabs items={['Example', 'Code']} defaultIndex="0">
  <Tab>
    <OverviewSection><AccordionMultipleUsage/></OverviewSection>
  </Tab>
  <Tab>
    ```tsx
    () => {
