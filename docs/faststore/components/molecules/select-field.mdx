...
Select Field wraps a [Select](https://developers.vtex.com/docs/guides/faststore/atoms-select) input and its corresponding [Label](/componentes/atoms/label). It allows users to select one option from a set.
