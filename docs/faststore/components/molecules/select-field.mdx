---
title: "Select Field"
excerpt: SelectField grouped a Select input and its corresponding Label.
...
Select Field wraps a [Select](/docs/guides/faststore/atoms-select) input and its corresponding [Label](/componentes/atoms/label). It allows users to select one option from a set.
