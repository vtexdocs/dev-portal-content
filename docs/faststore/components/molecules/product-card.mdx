      ...
      <ProductCard>
        ...
        <ProductCardContent
          ...
          deliveryPromiseBadges={
            <span style={{ fontSize: '0.75rem', color: 'var(--fs-color-info-text)' }}>
              Arrives tomorrow
            </span>
          }
        />
      ...
      return (
        <ProductCard>
          ...
          <ProductCardContent
            ...
            deliveryPromiseBadges={
              <Badge variant="info">Arrives tomorrow</Badge>
            }
          />
        </ProductCard>
      );
...
<SectionList grid="column">
  <SectionItem
    title="ProductShelf"
    description="
Displays a list of products to be used as a section of the store."
