---
title: "Product Card"
excerpt: ProductCard displays summarized information about a product.
keywords:
  - UI library
  - ecommerce
  - react
...
---low the instructions in the [Importing FastStore UI component styles](https://developers.vtex.com/docs/guides/faststore/using-themes-importing-ui-components-styles) tutorial.
