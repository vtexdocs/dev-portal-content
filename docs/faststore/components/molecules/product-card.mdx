...
- Present a product collection on the homepage.
...
Prefer using `buyButton` or `discountBadge`, but never both.
...
<Tabs items={["Example", "Code"]} defaultIndex="0">
  ...
  <Tab>
    ...
    export default function ProductCardWideWithButton() {
      return (
        <ProductCard variant="wide">
          <ProductCardImage aspectRatio={2 / 1}>
            <img
...
<Tabs items={["Example", "Code"]} defaultIndex="0">
  ...
  <Tab>
    ...
    export default function ProductCardWideWithBadge() {
      return (
        <ProductCard variant="wide">
          <ProductCardImage aspectRatio={2 / 1}>
            <img
...
To replicate this style, add the `outOfStock` prop to both `ProductCard` and `ProductCardContent`.
...
<Tabs items={['Example', 'Code']} defaultIndex="0">
  ...
  <Tab>
    ...
    export default function ProductCardOutOfStock() {
...
<Tabs items={["Example", "Code"]} defaultIndex="0">
  ...
  <Tab>
    ...
    export default function ProductCardBordered() {
      return (
        <ProductCard bordered>
          <ProductCardImage>
            <img
...
<TokenTable>
  <TokenRow
    token="--fs-product-card-delivery-promise-badge-text-size"
    value="var(--fs-text-size-tiny)"
    isColor
  />
  <TokenRow
    token="--fs-product-card-delivery-promise-badge-status-width"
    value="var(--fs-spacing-1)"
    isColor
  />
  <TokenRow
    token="--fs-product-card-delivery-promise-badge-status-border-radius"
    value="var(--fs-border-radius-circle)"
    isColor
  />
  <TokenRow
    token="--fs-product-card-delivery-promise-badge-status-available"
    value="var(--fs-color-success-2)"
    isColor
  />
  <TokenRow
    token="--fs-product-card-delivery-promise-badge-status-unavailable"
    value="var(--fs-color-neutral-bkg)"
    isColor
  />
</TokenTable>
...
<SectionList grid="column">
  <SectionItem
    title="ProductShelf"
    description="
Displays a list of products to be used as a section in the store."
