...
<Tabs items={['Example', 'Code']} defaultIndex="0">
  ...
  <Tab>
    ...
    export default function ProductCardBasicUsage() {
      const product = {
        isVariantOf: { name: 'Basic Product' },
        image: [
          {},
...
>
  ...
  <Tab>
    ...
    export default function ProductCardWideExamples() {
      const product = {
        isVariantOf: { name: 'Basic Product' },
        image: [
          {},
      ...
      return (
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 2fr', gap: '0.5rem' }}>
          <ProductCard variant="wide">
            <ProductCardImage aspectRatio={2 / 1}>
              <img
                data-fs-image
