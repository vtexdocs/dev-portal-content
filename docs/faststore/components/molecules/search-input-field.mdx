...
An [InputField](/docs/guides/faststore/molecules-input-field) with a search button. This component is part of the [Search](/docs/guides/faststore//feature-search) feature.## Import
