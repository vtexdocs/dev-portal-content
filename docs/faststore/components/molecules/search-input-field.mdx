...
An [InputField](https://developers.vtex.com/docs/guides/faststore/molecules-input-field) with a search button. This component is part of the [Search](https://developers.vtex.com/docs/guides/faststore//feature-search) feature.## Import
