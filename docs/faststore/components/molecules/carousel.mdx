---
title: "Carousel"
excerpt: "The Carousel component is great for swiping images."
...
>⚠️ This component is a work in progress, so it might work as expected in some cases, we gratefully accept feedback.
