...
excerpt: Checkbox Field grouped a Checkbox input and its corresponding Label.
...
Checkbox Field wraps a [Checkbox](/docs/guides/faststore/atoms-checkbox) input and its corresponding [Label](/docs/guides/faststore/atoms-label). It allows users to select one option from a set.
