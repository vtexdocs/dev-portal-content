...
Checkbox Field wraps a [Checkbox](https://developers.vtex.com/docs/guides/faststore/atoms-checkbox) input and its corresponding [Label](https://developers.vtex.com/docs/guides/faststore/atoms-label). It allows users to select one option from a set.
