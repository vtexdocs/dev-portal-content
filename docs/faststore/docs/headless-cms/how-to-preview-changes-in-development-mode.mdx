---
title: 'How to preview Headless CMS in development mode'
---
...
6. Click on `Preview`. A new tab will open
...
> ⚠️ Replace `<contentType>`, `<DOCUMENT_ID>`, and `<VERSION_ID>` with the values from your preview link.

8. Once you have reviewed your changes, terminate the development mode by opening the terminal in the `Developer Tools` and running  the following command in the Headless CMS page:
