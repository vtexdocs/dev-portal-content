...
3. Expand the pre-filled item, **Item # 0**, which is automatically created during the [FastStore Onboarding](https://developers.vtex.com/docs/guides/faststore/getting-started-overview) process for your project.
