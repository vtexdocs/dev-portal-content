...
4. Fill the **Preview URL** field with your live store URL. This URL activates the button on Headless CMS so you can preview the changes made on a page. 
    ...
    ```sh
    https://{live-store-id}.vtex.app/api/preview
    ```
  > Replace the values between curly brackets according to your [live store ID from WebOps](https://developers.vtex.com/docs/guides/faststore/1-onboarding-dashboard#production-overview). You can find the live store ID in the VTEX Admin by accessing **Storefront > FastStore WebOps**. In the [**Production Overview**](https://developers.vtex.com/docs/guides/faststore/1-onboarding-dashboard#production-overview) card, locate the **Live Store** URL. The live store ID is a combination of the store account name and the live store ID number, for example: `mystore-clwjc7fw200ay9qau1smn8i4l-21vm59f3q.b`. For this example, the Preview URL is the following: `https://mystore-clwjc7fw200ay9qau1smn8i4l-21vm59f3q.b.vtex.app/api/preview`.
