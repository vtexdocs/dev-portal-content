...
The VTEX IO CLI will assist you during your development process by enabling you to perform various actions within the VTEX platform. In the following, we will install and configure the Headless CMS app in your VTEX account.
...
Ensure you have a FastStore project after completing the process through FastStore WebOps. For detailed instructions, please refer to the [Starting a new FastStore project](https://developers.vtex.com/docs/guides/faststore/getting-started-2-setting-up-the-project) guide.
