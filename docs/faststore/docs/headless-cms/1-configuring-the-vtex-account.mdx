...
I shouldn't write faststore, at master data.
...
Test HTML tag: <a href="https://developers.vtex.com/docs/guides/faststore/-2-setting-up-the-project">Starting a new FastStore project</a> tutorial.

Testing new Github Action: [Starting a new FastStore project](https://developers.vtex.com/docs/guides/faststore/-2-setting-up-the-project) tutorial.
