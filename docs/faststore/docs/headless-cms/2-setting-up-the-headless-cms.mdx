...
By the end of this part of the tutorial, you will be able to see your first definition of a Content Type available for use in the Headless CMS app. Next, you will dive deeper into creating these definitions.
