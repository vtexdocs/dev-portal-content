...
Now that you are familiar with the core concepts of the [Headless CMS](https://developers.vtex.com/docs/guides/faststore/headless-cms-overview) and have set it up in your VTEX account, let's go back to your **FastStore** project to define your own **Content Types** and **Sections**.

By the end of this part of the tutorial, you will be able to see your first definition of a Content Type available for use in the Headless CMS app. Next, you will dive deeper into how to create these definitions.
...
To add and manage sections on your store's pages, all sections must be available in the Headless CMS. To integrate your FastStore project, refer to the [Headless CMS integration track](https://developers.vtex.com/docs/guides/faststore/headless-cms-overview).
...
> ⚠️ If you have `@vtex/cli-plugin-cms@1.0.7` installed, you can use the `{builderName}` argument to sync a specific builder: `vtex cms:sync {builderName}`.
