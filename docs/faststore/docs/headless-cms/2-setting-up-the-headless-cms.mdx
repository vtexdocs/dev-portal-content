...
By the end of this part of tutorial, you will be able to see your first definition of a Content Type available for use in the Headless CMS app. Next, we will dive deeper into how to create these definitions.
