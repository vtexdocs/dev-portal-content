...
By the end of this part of the tutorial, you will be able to see your first definition of a content type available for use in the Headless CMS app. Next, we will dive deeper into how to create these definitions in a smoother way.
...
Ensure that you install the FastStore CLI to use its commands locally. Refer to the [FastStore CLI](https://developers.vtex.com/docs/guides/faststore/getting-started-3-faststore-cli) guide for more information.
