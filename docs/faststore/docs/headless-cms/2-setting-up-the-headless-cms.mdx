...
Now that you are familiar with the core concepts of the [Headless CMS](https://developers.vtex.com/docs/guides/faststore/headless-cms-overview) and have set it up in your VTEX account, let's go back to our **FastStore** project to define our own **Content Types** and **Sections**.
