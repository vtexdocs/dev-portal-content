...
However, no Sections will be available yet. We'll learn more about this in the following part of this track, [Structuring Content Types and Sections](https://developers.vtex.com/docs/headless-cms-integration/3-adding-content-types-and-sections).
