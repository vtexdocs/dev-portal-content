---
title: 'Working with Headless CMS (legacy)'
---


> ⚠️ This guide covers the Headless CMS (legacy), which is available for FastStore v1, v2, v3, and Headless storefronts. If you are using FastStore v3, consider using the new [CMS](https://developers.vtex.com/docs/guides/upgrading-from-headless-cms-legacy-to-cms-overview), which offers improved content modeling, Git-like branching, and multi-language support.

In this guide, you will be presented with the Headless CMS (legacy), a solution for content management. By using the Headless CMS, you can empower editors to create, edit, and publish web content independently through the VTEX Admin.
...
After onboarding through [FastStore WebOps](https://developers.vtex.com/docs/guides/faststore/getting-started-2-starting-the-project), users can manage their FastStore project on VTEX Admin by navigating to **Storefront > Headless CMS** under the [Projects](https://help.vtex.com/tutorial/managing-projects--42IpDFqTVTESH8DCypJMPM) feature.
