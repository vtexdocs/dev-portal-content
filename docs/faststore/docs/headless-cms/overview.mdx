...
- Associated the following resources with your VTEX user role to be able to manage the Headless CMS:
...
After successfully completing the [FastStore Onboarding process](/docs/guides/faststore/getting-started-1-faststore-onboarding-overview), the app will be installed in your VTEX account. To access it go to the VTEX Admin and navigate to **Storefront > Headless CMS**.
...
For each Content Type, different **Sections** will be available to compose that page. Sections represent the content structure of a React component, for example, the [Alert](/docs/guides/faststore/molecules-alert).

![CMS Section](https://vtexhelp.vtexassets.com/assets/docs/src/cms-sections___ccc8b00d73f222d249a009eb195c8e0c.png)

Sections can be reused in different pages of an ecommerce. You are the one who will choose which Sections will be available at the CMS. Check the following example of the [*Hero Section*](/docs/guides/faststore/organisms-hero) being used:
