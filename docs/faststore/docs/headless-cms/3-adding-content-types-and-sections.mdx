...
> ℹ️ This command will monitor any changes in the project, including the new section you have created, and automatically merge it with the default sections available in [`faststore/core`](/docs/getting-started/3-project-structure#faststorecore).
...
> ℹ️ For more information on how to write a `schema`, check the [`JSON Schema Reference`](https://json-schema.org/understanding-json-schema/index.html).
...
you can follow the instructions provided in the guide [Creating a new section](/docs/guides/faststore/building-sections-creating-a-new-section). 
...
> ℹ️ For more information on each property of a `schema`, check the [`JSON Schema Reference`](https://json-schema.org/understanding-json-schema/index.html).
