...
> ℹ️ This command will monitor any changes in the project, including the new section you have created, and automatically merge it with the default sections available in [`faststore/core`](https://developers.vtex.com/docs/getting-started/3-project-structure#faststorecore).
