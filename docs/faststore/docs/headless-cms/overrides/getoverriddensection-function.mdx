---
title: 'getOverriddenSection function'
---
...
| `components` | An object containing overrides for specific components within the section. The keys of this object should match the component names used in the section, and the values should be objects defining overrides for those components.  For more details on overrides, refer to [Overriding components props](https://developers.vtex.com/docs/guides/faststore/overrides-component-props) and [Overriding a component](https://developers.vtex.com/docs/guides/faststore/overrides-native-component). |
| `className`  | Property that behaves similarly to [React's `className`](https://react.dev/reference/react-dom/components/common#applying-css-styles).             | 
