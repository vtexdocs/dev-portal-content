---
title: 'Overriding native components and props (v1)'
---

> ⚠️ This content applies only to stores using [Headless CMS (legacy)](https://developers.vtex.com/docs/guides/faststore/headless-cms-overview).
> ⚠️ This guide is for stores using Section overrides v1. For instructions on how to use Section overrides v2, refer to the [Section overrides v2](https://developers.vtex.com/docs/guides/faststore/overrides-overview)
...
```tsx ProductDetails.tsx mark=8:9
import { SectionOverride } from '@faststore/core'
...
> ⚠️ Note that this will only work if your custom component's props are compatible with the overriding component. We encourage using [FastStore UI components](https://developers.vtex.com/docs/guides/faststore/) to leverage existing features, basic styles, and better props compatibility.
