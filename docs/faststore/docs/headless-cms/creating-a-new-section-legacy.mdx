---
title: 'Creating a new section (Headless CMS (legacy))'
---

> ⚠️ This guide applies only to stores using [Headless CMS (legacy)](https://developers.vtex.com/docs/guides/faststore/headless-cms-overview). For stores using the [CMS](https://developers.vtex.com/docs/guides/cms-for-faststore-storefronts), refer to [Creating a new section in the CMS](https://developers.vtex.com/docs/guides/creating-a-new-section) instead.
