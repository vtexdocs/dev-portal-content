...
Widgets are interface elements in the [Headless CMS](https://developers.vtex.com/docs/guides/faststore/headless-cms-overview) that merchants can use to manage store sections. These can include date pickers, dropdown menus, image uploaders, and more, helping to create and edit content.
