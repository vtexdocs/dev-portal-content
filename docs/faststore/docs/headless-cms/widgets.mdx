...
- [Available widgets](#available-widgets): Default widgets to implement in store sections.
- [Example on how to add a widget to a section](#adding-a-widget-to-a-store-section): An implementation example on how to add a widget to a new store section.

## Available widgets

Below is a brief description of the widgets that can be implemented and used in the Headless CMS interface in the VTEX Admin. For detailed information about each widget, click on the respective widget name and for an implementation example of adding a widget to a store section, see the [Adding a widget to a store section](#adding-a-widget-to-a-store-section).
...
### Synchronize the changes with Headless CMS
