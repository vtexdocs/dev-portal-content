...
> ⚠️ The `useCart` hook is available from [Experimental exports - Hooks and Components](https://developers.vtex.com/docs/guides/faststore/developing-and-customizing-components-experimental-exports-hooks-and-components) as `useCart_unstable`. This is the recommended import for FastStore projects. For instructions on how to use experimental hooks, see [Experimental exports - Hooks and Components](https://developers.vtex.com/docs/guides/faststore/developing-and-customizing-components-experimental-exports-hooks-and-components).
