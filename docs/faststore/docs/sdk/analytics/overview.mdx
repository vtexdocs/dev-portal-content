...
<WhatsNextCard
  linkTo="https://developers.vtex.com/docs/guides/faststore/analytics-send-analytics-event"
  title="sendAnalyticsEvent"
  description="Learn how to trigger and manage analytics events in your store using the sendAnalyticsEvent function, which follows the Google Analytics 4 (GA4) data model."
  linkTitle="See more"
/>

<WhatsNextCard
  linkTo="https://developers.vtex.com/docs/guides/faststore/analytics-use-analytics-event"
  title="useAnalyticsEvent"
  description="Learn how to use the useAnalyticsEvent hook to intercept and respond to both native and custom analytics events triggered by the sendAnalyticsEvent function."
  linkTitle="See more"
/>
