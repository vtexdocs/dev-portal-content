...
<WhatsNextCard
  ...
  description="The sendAnalyticsEvent function enables the triggering and management of analytics events in stores, following the Google Analytics 4 (GA4) data model."
  linkTitle="See more"
/>
...
<WhatsNextCard
  ...
  description="The useAnalyticsEvent hook enables intercepting and responding to both native and custom analytics events triggered by the sendAnalyticsEvent function."
  linkTitle="See more"
/>
