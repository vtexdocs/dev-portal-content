...
The `sendAnalyticsEvent` function centralizes and aggregates tracking events, and it also supports [custom events](https://developers.vtex.com/docs/guides/faststore/analytics-sending-custom-events).
