...
If you have multiple custom events, such as adding/removing items using the cart or viewing products, you can define a unified type to handle them all. This approach simplifies firing multiple events from the same interface.
