...
For standard cart management in FastStore projects, the recommended approach is to use the [`useCart_unstable`](https://developers.vtex.com/docs/guides/faststore/cart-use-cart) hook and the `cartStore_unstable` store. See [Experimental exports - Hooks and Components](https://developers.vtex.com/docs/guides/faststore/developing-and-customizing-components-experimental-exports-hooks-and-components) for the full list of available hooks. The `@faststore/sdk` Cart module is intended for cases where you need to implement your own custom state manager.

> ℹ️ Learn more about validating the cart in the shopper's browser against the information in the platform with [FastStore API mutations](https://developers.vtex.com/docs/guides/faststore/schema-mutations#cart).

## Session

The Session module manages the state of session information in the shopper's browser. This includes currency, channel, localization, and shopper information. To learn more about this module, see the [Session](https://developers.vtex.com/docs/guides/faststore/sdk-session) data structure and usage.

> ℹ️ Learn more about validating the cart in the shopper's browser against the information in the platform with [FastStore API mutations](https://developers.vtex.com/docs/guides/faststore/schema-mutations#session).
...
Install [`@faststore/sdk`](https://developers.vtex.com/docs/guides/faststore/getting-started-4-understanding-the-project-structure#packagejson) as a dependency of your FastStore project via the command line:
