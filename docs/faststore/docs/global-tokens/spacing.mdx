---
title: "Spacing"
excerpt: "All tokens used for spacings on the store: `padding`, `margins` and `sizes`. It's also used as base for grid tokens."
slug: spacing
---

import { TokenTable, TokenRow } from 'site/components/Tokens'

All tokens used for spacings on the store: `padding`, `margins` and `sizes`. It's also used as base for grid tokens.<TokenTable title="Global Token" description="Value">
