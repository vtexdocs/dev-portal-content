...
updatedAt: "2026-05-12T14:47:17.858Z"
---

**FastStore monorepo** is the unified repository model that centralizes storefront development on VTEX.
...
The storefront is organized into modules, which are sets of pages that comprise the storefront. Each module represents a primary functional area of the ecommerce storefront experience on VTEX. We support three modules:
...
>ℹ️ You can see more examples of `faststore.json` configuration in the [Monorepo use cases](https://developers.vtex.com/docs/guides/faststore/monorepo-use-cases) guide.
...
linkTo="https://developers.vtex.com/docs/guides/faststore/monorepo-creating-new-projects"
linkTitle="See more"
/>

<WhatsNextCard
title="Monorepo use cases"
description="Explore the look and feel of your store by using Themes and FastStore CSS stylesheets."
linkTo="https://developers.vtex.com/docs/guides/faststore/monorepo-use-cases"
linkTitle="See more"
/>