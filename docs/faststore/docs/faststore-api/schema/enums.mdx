...
> ℹ️ To learn more about how the VTEX catalog is structured, see [Categories](https://help.vtex.com/en/tutorial/categories--2ftXf22SQWE2iKMmAEeViJ), [Brands](https://help.vtex.com/en/tutorial/what-is-a-brand--QU07yhHoaWgaqkq8y0ygc), and [Product Clusters](https://help.vtex.com/en/tutorial/creating-a-product-cluster--tutorials_6157) guides.
