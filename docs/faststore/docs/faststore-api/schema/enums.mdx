...
> ℹ️ To learn more about how the VTEX catalog is structured, see [Categories](https://help.vtex.com/docs/tutorials/what-is-a-category), [Brands](https://help.vtex.com/en/tutorial/what-is-a-brand), and [Product Clusters](https://help.vtex.com/en/tutorial/creating-a-product-cluster) guides.
