...
3. Go to the **Network** tab and look for **HIT** cache indicators on GET request as the image below:
   ![cache-hit](https://vtexhelp.vtexassets.com/assets/docs/src/graphql-cache-control-flag___fc3e68d4013087ccf826b2b1b4217de9.png)

### Recommended values for `maxAge` and `staleWhileRevalidate`

{/* Is that possible to recommend `maxAge` and `staleWhileRevalidate` values? See an example on how we could demonstrate below
