...
You can customize your query to get exactly the data you need and even use the [API extension](https://developers.vtex.com/docs/api-extensions) feature to fetch data not natively available. Following these best practices helps to maintain your site's performance at optimal levels.
...
Extend the FastStore API schema by leveraging [API extensions](https://developers.vtex.com/docs/api-extensions):
