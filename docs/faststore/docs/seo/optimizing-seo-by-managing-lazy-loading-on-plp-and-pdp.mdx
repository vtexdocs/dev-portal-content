...
However, be cautious: disabling lazy loading for too many elements can increase initial page load time. It should be used only for critical, above-the-fold content. 
