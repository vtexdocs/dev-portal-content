...
<details>
<summary>When to use lazy loading? ✅</summary>

<CheckboxField
  label="The content is not immediately visible"
  id="checkboxfield-account"
/>
...
<CheckboxField
  label="The page speed needs to be improved"
  id="checkboxfield-account"
/>
...
<CheckboxField
  label="The content doesn't affect SEO or crawling"
  id="checkboxfield-account"
/>
