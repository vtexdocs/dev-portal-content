...
Lazy loading can improve store performance and SEO, but it must be used strategically. Below is a checklist to help you decide when to implement lazy loading to balance fast page speed with search engine crawlability.

<details>
<summary>When to use lazy loading? ✅</summary>

<CheckboxField
  label="To load content that isn't immediately visible"
  id="checkboxfield-account"
/>

<details>
<summary>Use lazy loading for content that appears below the fold—the part of a webpage that users must scroll down to see.</summary>
...
<CheckboxField
  label="To improve page speed for a media-heavy page"
  id="checkboxfield-account"
/>

<details>
<summary>Use lazy loading for delay the content that isn't essential for the initial view.</summary>
...
<details>
<summary>Use lazy loading for content that isn't essential for search engine optimization.</summary>

This includes content that doesn't contain structured product data or other critical SEO information.
...
<CheckboxField label="To balance server load during high traffic" id="checkboxfield-account" />

<details>
<summary>Use lazy loading to manage server load on pages with many images or heavy resources.</summary>

This can prevent server spikes and ensure a faster browsing experience for shoppers.
