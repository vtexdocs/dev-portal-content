...
These features are useful when you need a customized behavior for a specific component not available in the [FastStore native options](/docs/guides/faststore/building-sections-list-of-native-sections).

> ⚠️ We highly recommend considering [overriding props](#override-native-components-props) or utilizing the [theming tools](/docs/customizing/components) provided by `@faststore/core` to achieve the desired behavior. Overriding a component inside a section will compromise the existing integration developed in [`@faststore/core`](/docs/getting-started/3-project-structure#faststorecore) by losing updates for that component.
...
Make sure you have a functioning FastStore project after following the [FastStore onboarding](/docs/guides/faststore/getting-started-1-faststore-onboarding-overview) and [setting up the project](/docs/getting-started/2-setting-up-the-project).
...
Refer to the [List of native sections and overridable components](/docs/guides/faststore/building-sections-list-of-native-sections#faststore-native-sections) to explore available native sections.
...
All component customizations in FastStore are performed within a section and to override props, you need to choose the desired native section and component from the [List of available native sections](/docs/guides/faststore/building-sections-list-of-native-sections#faststore-native-sections).

For this guide, we'll use the [`BuyButton`](/docs/guides/faststore/molecules-buy-button#props) component to make the customization.
...
1. After choosing a native section to be customized from the [list of available native sections](/docs/guides/faststore/building-sections-list-of-native-sections), open your FastStore project in any code editor of your preference.
