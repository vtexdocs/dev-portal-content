...
When [FastStore's native sections](https://developers.vtex.com/docs/guides/faststore/developing-and-customizing-components-list-of-native-sections) don't meet your storefront requirements, you can build a custom React section and expose its properties as editable fields in the [VTEX CMS](https://developers.vtex.com/docs/guides/cms-for-faststore-storefronts).
...
| Change the visual appearance of the storefront | [Themes and design tokens](https://developers.vtex.com/docs/guides/faststore/using-themes-components) |
...
- You understand the relationship between [components and sections](https://developers.vtex.com/docs/guides/understanding-components-and-sections).
- You can run the FastStore storefront locally. For setup instructions, see [Setting up your development environment](https://developers.vtex.com/docs/guides/faststore/getting-started-1-setting-up-your-environment).
