...
When FastStore's native sections don't meet your storefront requirements, you can build a custom React section and expose its properties as editable fields in the [VTEX CMS](https://developers.vtex.com/docs/guides/cms-for-faststore-storefronts).
