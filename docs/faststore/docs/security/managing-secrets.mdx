...
updateAt: "2025-12-04T17:14:30.538Z"
---
...
VTEX offers a permissions system, so only users assigned to a role with the required [License Manager resources](https://help.vtex.com/en/tutorial/license-manager-resources--3q6ztrC8YynQf6rdc6euk3) can manage secrets.
...
>⚠ After creating, updating, or deleting a secret, there is a short propagation delay before the new values become available to the next build. To ensure the change is applied, wait **5 minutes** after saving, then trigger a deployment.
>
> If you have already deployed right after creating, updating, or deleting a secret and do not see the changes in your application, wait a few minutes and run another deploy before opening a support ticket.
