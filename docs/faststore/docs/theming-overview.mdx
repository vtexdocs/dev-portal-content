...
However, you have the option to use one of the [available themes](/docs/guides/faststore/themes-overview#available-themes) or [create a custom theme](/docs/guides/faststore/themes-overview#creating-a-custom-theme).
