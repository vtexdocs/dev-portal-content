...
The [Headless CMS](/docs/guides/faststore/docs-headless-cms-overview) is the content management solution for FastStore projects. During the [Onboarding](/docs/guides/faststore/getting-started-1-faststore-onboarding),
