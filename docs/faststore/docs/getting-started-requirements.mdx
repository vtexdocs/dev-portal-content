...
The [Headless CMS](https://developers.vtex.com/docs/guides/faststore/docs-headless-cms-overview) is the content management solution for FastStore projects. During the [Onboarding](/docs/guides/faststore/getting-started-1-faststore-onboarding),
...
[Open a ticket with the VTEX support team](https://help.vtex.com/support) and request the installation of the [FastStore Onboarding](/docs/guides/faststore/getting-started-1-faststore-onboarding-overview) app.
