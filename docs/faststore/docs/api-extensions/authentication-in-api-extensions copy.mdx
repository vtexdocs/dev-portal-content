...
> ⚠️ The steps below are required whenever question 3 is yes and either question 1 or question 2 is also yes. This applies to any service the resolver calls, and to both VTEX app keys and tokens issued by external providers.
