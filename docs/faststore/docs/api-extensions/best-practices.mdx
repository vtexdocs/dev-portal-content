...
Make sure your store version is updated to v3.0.0 or above.  If it’s not updated, refer to the [Updating your `@fastore/core` package version](https://developers.vtex.com/docs/guides/faststore/project-structure-updating-the-core-package-version) section. 
