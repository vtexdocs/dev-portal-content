...
| [Displaying the loyalty balance of a signed-in shopper](https://developers.vtex.com/docs/guides/faststore/api-extensions-use-cases-displaying-the-loyalty-balance-of-a-signed-in-shopper) | Displays the loyalty points of the signed-in shopper on the account page, using the shopper's own credentials. |
