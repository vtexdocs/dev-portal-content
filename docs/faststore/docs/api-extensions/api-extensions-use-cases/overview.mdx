...
| [Displaying an order summary for the signed-in shopper](https://developers.vtex.com/docs/guides/faststore/api-extensions-use-cases-displaying-an-order-summary-for-the-signed-in-shopper) | Displays how many orders the signed-in shopper has placed, using the shopper's own session. |
