...
follow the steps below to add custom fields to an [existing query](https://developers.vtex.com/docs/api-extensions#extendable-queries). We will use the `ServerProduct` query as an example to illustrate how to extend.
