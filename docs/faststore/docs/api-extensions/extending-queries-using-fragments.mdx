...
import { ExtendableQueryTable } from 'site/components/ExtendableQueryTable'
...
> ℹ️ To access the list of queries and their corresponding fragments, refer to the [extendable queries](/docs/api-extension/extending-queries-using-fragments#extendable-queries) section.
...
Now, you can consume `customData` by following the [Consuming FastStore API extension with custom components](/docs/guides/faststore/api-extensions-consuming-api-extensions) guide.
