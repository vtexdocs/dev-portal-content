---
title: "Midnight"
excerpt: "A darkmode theme created for testing purposes."
slug: midnight
---

A darkmode theme for your storefront.

![midnight-theme](https://vtexhelp.vtexassets.com/assets/docs/src/midnight___2bb274e36a39ff9c2cfa3dcc740cbfab.png)
...
3. Go to `discovery.config.js` and change the `theme` to `midnight`:

```js filename="discovery.config.js"
theme: 'midnight',
```

4. To preview how the new theme appears in your store, open the terminal, run yarn dev, and access the local server available.
