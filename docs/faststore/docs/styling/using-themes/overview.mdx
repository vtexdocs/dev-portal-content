...
Global design tokens are parameters that affect all UI appearance. They are the main configuration file of a Theme. It's constituted of three main groups:
