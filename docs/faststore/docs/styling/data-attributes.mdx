...
For the complete data attributes list, see the component reference for [Button](https://developers.vtex.com/docs/guides/faststore/atoms-badge#data-attributes), [Input](https://developers.vtex.com/docs/guides/faststore/atoms-input#data-attributes), [Badge](/docs/guides/faststore/atoms-badge#data-attributes), and [Icon](https://developers.vtex.com/docs/guides/faststore/atoms-icon#data-attributes).
...
For the complete data attributes list, see the component reference for [ProductCard](https://developers.vtex.com/docs/guides/faststore/molecules-product-card#data-attributes), [Table](https://developers.vtex.com/docs/guides/faststore/molecules-table#data-attributes), and [Modal](https://developers.vtex.com/docs/guides/faststore/molecules-modal#data-attributes).
...
> ⚠️ Always use design tokens instead of hardcoded values. This ensures consistency across your theme and makes it easier to maintain and update your styles. Learn more about available tokens in the [Design tokens documentation](https://developers.vtex.com/docs/guides/faststore/global-tokens-overview).
...
Override component styles using [design tokens](https://developers.vtex.com/docs/guides/faststore/global-tokens-overview) (CSS custom properties) rather than hardcoded values. This keeps styles consistent across the design system and makes future updates easier.
