...
Data attributes in FastStore UI are a way to target and customize component styles using CSS. All FastStore UI components use a consistent `data-fs-` prefix for their data attributes, making it easy to identify and style components.
