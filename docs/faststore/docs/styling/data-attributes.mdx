...
To better understand how to target nested elements, here's the typical structure of a ProductCard component:
...
Override component styles using CSS custom properties (design tokens) rather than hardcoded values. This keeps styles consistent across the design system and makes future updates easier.
...
- **Don't break accessibility** - Ensure your custom styles maintain each component's accessibility.
