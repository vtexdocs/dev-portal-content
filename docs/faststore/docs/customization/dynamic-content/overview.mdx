...
- [Setting up your store code for Dynamic Content](https://developers.vtex.com/docs/guides/faststore/dynamic-content-setting-up-your-store-code): Request Fetch API or any HTTP library to fetch the data directly ([Axios](https://axios-http.com/docs/intro), fetch, etc). 
- [Consuming Dynamic Content within custom sections](https://developers.vtex.com/docs/guides/faststore/dynamic-content-rendering-within-custom-sections ): Fetch the data using the existing API Extension feature.
