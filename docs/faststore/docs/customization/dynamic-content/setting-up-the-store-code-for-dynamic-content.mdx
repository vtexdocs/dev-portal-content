...
You can render this data in your store sections once you've set up your dynamic content fetching functions and mappings. See the [consuming-the-dynamic-content-in-custom-sections](https://developers.vtex.com/docs/guides/faststore/dynamic-content-consuming-the-dynamic-content-in-custom-sections) guide for more information on using this data in a new section.
...
Once you've set up your dynamic content fetching functions and mappings, you can render this data in your store sections. For more information on using this data in a new section, see the [Consuming the Dynamic Content in custom sections](https://developers.vtex.com/docs/guides/faststore/dynamic-content-consuming-the-dynamic-content-in-custom-sections) guide.
