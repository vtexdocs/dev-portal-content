...
The starter provides a set of [native sections](https://developers.vtex.com/docs/guides/faststore/reference-list-of-native-sections), each consisting of different components with unique functionalities. You can customize the components inside its section using the available section and the component's data attributes.
...
To ensure visual consistency with your store's theme, we highly recommend utilizing the [global tokens](https://deploy-preview-563--elated-hoover-5c29bf.netlify.app/docs/guides/faststore/global-tokens-overview) whenever possible. Also, you can take advantage of the design tokens set provided by [FastStore UI Components](https://developers.vtex.com/docs/guides/docs-what-is-faststore/).
