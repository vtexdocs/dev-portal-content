...
seeAlso:
  ...
  - "/docs/guides/faststore/building-sections-component-customization-overview"
---
...
> ℹ️ Remember that when changing a component's style, you can use [Global tokens](https://developers.vtex.com/docs/global-tokens/overview) or styling from scratch using your preferred styling tool. However, changing the value of a global token may affect different parts of your store's interface.
...
If you want to apply this change in only one store component, follow the next step [Customizing a component within a section](https://developers.vtex.com/docs/customizing/components#customizing-a-component-within-a-section).

---

## Customizing a component within a section

The starter provides a set of [native sections](https://developers.vtex.com/docs/reference-guides/list-of-native-sections), each consisting of different components with unique functionalities. You can customize the components inside its section using the available section and the component's data attributes.
...
But we only want to apply this change in the `ProductShelf` section. So, we can use the `data-fs-product-shelf` data-attribute to select the [ProductShelf component](https://developers.vtex.com/docs/guides/faststore/organisms-product-shelf#customization) in this section.
...
When [overriding a native component](https://developers.vtex.com/docs/guides/faststore/building-sections-overriding-components-and-props#overriding-a-native-component) and using your custom component,
you may need to style it from scratch. In this section, you'll learn how to style a custom component.

### Before you begin

Make sure you have a basic understanding of [overriding native components and props](https://developers.vtex.com/docs/guides/faststore/building-sections-overriding-components-and-props).
...
For better understanding, we will use the example from the [Overriding Native Components and Props](https://developers.vtex.com/docs/guides/faststore/building-sections-overriding-components-and-props) guide.
...
To ensure visual consistency with your store's theme, we highly recommend utilizing the [global tokens](docs/global-tokens/overview) whenever possible. Also, you can take advantage of the design tokens set provided by [FastStore UI Components](https://developers.vtex.com/docs/guides/faststore/).
