...
While the [FastStore API](https://developers.vtex.com/docs/guides/faststore-api) provides a [GraphQL schema for ecommerce](https://v1.faststore.dev/reference/api/queries) that covers a general use case, some stores may need to access other, more specific, information.
...
[Best practices for fetching data](https://developers.vtex.com/docs/api-extensions#best-practices-for-fetching-data).
...
If you need to access other data not available in the native FastStore API schema, you must do this by using [API extension](https://developers.vtex.com/docs/api-extensions).
