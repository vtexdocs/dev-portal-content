...
<Callout type="info" emoji="ℹ️">
 To access the list of queries and their corresponding fragments, check the [extendable queries](https://developers.vtex.com/docs/guides/faststore/api-extensions-extending-queries-using-fragments) section.
</Callout>
...
These queries enable customization by adding or changing fields to align data retrieval with your store-specific requirements.
