...
`
```
Now, you can consume `customData` by following the [Consuming FastStore API extension with custom components](https://developers.vtex.com/docs/api-extensions/consuming-api-extensions) guide.
