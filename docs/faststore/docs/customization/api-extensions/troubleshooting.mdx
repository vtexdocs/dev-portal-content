...
Refer to the [GraphQL changes not visible during development](https://developers.vtex.com/docs/api-extension/troubleshooting#graphql-changes-not-visible-during-development) topic, to fix the issue.
