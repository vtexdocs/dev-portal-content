...
To see your changes locally, you need to set the Headless CMS preview to the development mode. For more information, refer to the [Previewing Headless CMS changes in development mode](https://developers.vtex.com/docs/guides/faststore/headless-cms-previewing-changes-in-development-mode) guide.
