...
> ⚠️ This documentation is currently being developed.
...
Make sure you have a functioning FastStore project after following the [FastStore onboarding](https://developers.vtex.com/docs/guides/faststore/getting-started-1-faststore-onboarding-overview) and [setting up the project](https://developers.vtex.com/docs/guides/faststore/getting-started-2-setting-up-the-project).
...
The [`@faststore/core`](https://developers.vtex.com/docs/guides/faststore/getting-started-3-project-structure#faststorecore) package provides a set of native sections, each consisting of different components with unique functionalities.
