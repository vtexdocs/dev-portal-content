...
In this guide, you'll learn how to create a new section for your store and make it available in the [Headless CMS](https://developers.vtex.com/docs/headless-cms-overview). This solution is useful when your store requires a section not natively available in FastStore.
...
All sections must be available in the Headless CMS so they can be added and managed on your store's pages. To integrate your FastStore project, please refer to the [Headless CMS integration track](https://developers.vtex.com/docs/headless-cms-integration/1-configuring-the-vtex-account).
...
Make sure to install the FastStore CLI to use its commands locally. Refer to the [FastStore CLI](https://developers.vtex.com/docs/getting-started/4-faststore-cli#installing-faststore-cli-globally-using-npm) guide for more information.
