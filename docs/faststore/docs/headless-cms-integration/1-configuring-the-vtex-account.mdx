...
> ⚠️ - **Windows user:** if you find problems while installing the plugin, please refer to the [Troubleshooting](/docs/guides/faststore/error-installing-headless-cms) article
>
