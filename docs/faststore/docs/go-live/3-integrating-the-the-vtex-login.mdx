...
slug: 3-integrating-the-the-vtex-login
---
...
- Ensure you have already [configured the custom domain name of your FastStore website](/docs/guides/faststore/go-live-2-configuring-external-dns).
