...
- [Set up your VTEX account.](/docs/faststore/go-live-1-setting-up-vtex-account-for-faststore)
- Develop your FastStore project with **Next.js** by following the [Getting Started track](/docs/faststore/1-faststore-onboarding-overview).
...
6. Add the `SITE_HOST` key with the main domain specified in [Configuring domains in VTEX Account Settings](/docs/faststore/go-live-2-configuring-external-dns#step-2---configuring-domains-in-vtex-account-management) as the value.
