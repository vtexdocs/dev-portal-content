...
To proceed, make sure your store is active and in production, to do this, follow the steps in the article [Putting your account into production](https://help.vtex.com/en/tracks/go-live-your-store--4Ns5FxIiksmjsdX2yOTduM/7wFsbWgN4rnZsbjhv8IItX#putting-your-account-into-production).### Step 3 - Configuring domains in VTEX Account Settings
