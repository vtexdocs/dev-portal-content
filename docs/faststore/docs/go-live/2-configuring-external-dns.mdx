...
slug: 2-configuring-external-dns
---
...
- [Set up your VTEX account.](/docs/guides/faststore/go-live-1-setting-up-vtex-account-for-faststore)
...
6. Add the `SITE_HOST` key with the main domain specified in [Configuring domains in VTEX Account Settings](/docs/guides/faststore/go-live-2-configuring-external-dns#step-2---configuring-domains-in-vtex-account-management) as the value.
