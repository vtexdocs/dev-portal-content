...
Before proceeding any further, make sure you have already [configured the custom domain name of your FastStore website](https://developers.vtex.com/docs/guides/faststore/go-live-2-configuring-external-dns).
