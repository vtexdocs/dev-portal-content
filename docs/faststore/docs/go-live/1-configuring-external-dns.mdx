...
excerpt: 'Learn how to configure external DNS settings for your FastStore and VTEX website to use a custom domain.'
createdAt: '2024-01-01T00:00:00Z'
updateAt: '2025-09-23T00:00:00Z'
---
...
Returning to your FastStore project, you must also configure your project to point to the right addresses and domains.
