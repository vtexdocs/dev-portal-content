...
While the [FastStore API](/docs/guides/faststore-api) provides a [GraphQL schema for ecommerce](https://v1.faststore.dev/reference/api/queries) that covers a general use case, some stores may need to access other, more specific, information.
...
as you can see in the step 2 of [Creating resolvers](/docs/api-extensions/extending-api-schema#step-3---creating-resolvers).### Avoid custom API Routes
