---
title: "Setting up the Headless CMS"
excerpt: "Define your first Content Type and sync it with Headless CMS to make it available for editing in VTEX Admin."
sidebar_label: "Integrating your storefront with Headless CMS"
---

Now that [Headless CMS](https://developers.vtex.com/docs/guides/faststore/headless-cms-overview) is integrated with your FastStore project, you'll define your own **Content Types** and **Sections** so editors can create and manage pages in the VTEX Admin.
...
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `content-types.json` | An array of JSON objects that describes the **Content Types** available for customization in the Headless CMS app.                                        |
| `sections.json`      | An array of JSON objects that describes the content structure of the frontend **Section** components available for customization in the Headless CMS app. |
...
Now that you've created your first Content Type, learn to structure more complex Content Types and Sections: [Structuring Content Types and Sections](https://developers.vtex.com/docs/guides/faststore/headless-cms-3-adding-content-types-and-sections)
