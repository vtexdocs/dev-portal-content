...
>⚠️ For FastStore projects hosted in the `vtex-sites` organization not using WebOps ([FastStore v1](https://v1.faststore.dev/docs)) that you want to migrate to the GitHub organization of the account, open a ticket to the [VTEX Support](https://support.vtex.com/hc/en-us/requests).
