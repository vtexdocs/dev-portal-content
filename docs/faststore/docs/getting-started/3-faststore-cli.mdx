...
Also the CLI is the responsible on keeping the stores up-to-date with the [`@faststore/core`](https://developers.vtex.com/docs/guides/faststore/project-structure-overview#faststorecore) package and enables the cloud platform to understand the FastStore project.
