...
1. Open the terminal and navigate to the directory where you want to store your project.
    ...
    > ℹ️ For Windowns users we highly recommend to enable the [Developer mode](https://developers.vtex.com/docs/guides/faststore/getting-started-2-setting-up-the-project#enabling-developer-mode-windows-users) to run the terminal.
