...
import { Callout, Tab, Tabs, Steps } from 'nextra-theme-docs'Now that your store is up and running after [FastStore Onboarding](/docs/guides/faststore/getting-started-1-faststore-onboarding-overview), you're ready to set up your development environment and create a unique storefront that reflects your brand. Let's get started!
