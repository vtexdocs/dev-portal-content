...
Now that your store is up and running after [FastStore Onboarding](https://developers.vtex.com/docs/guides/faststore/1-faststore-onboarding-overview), you're ready to set up your development environment and create a unique storefront that reflects your brand. Let's get started!
...
2. Clone the repository created during the [FastStore Onboarding](Developer mode](https://developers.vtex.com/docs/guides/faststore/1-onboarding-starting-the-project#step-2-deploying-the-project) by running the following command in the terminal:
...
Let's make the first level of customization which updates the store's [theme](/docs/guides/faststore/themes-overview). For this customization, we are going to use the [Soft Blue theme](/docs/guides/faststore/themes-soft-blue).
