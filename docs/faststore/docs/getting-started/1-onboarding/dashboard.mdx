...
![deployment-details](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@EDU-14723-faststore-dashboard/images/deployment-details.gif)
...
The **Settings** tab allows you to quickly configure the production domains, without needing VTEX intervention.
...
> ⚠️ The proper configuration of the **Settings** tab is an essential step in the process of going live. For further information, see [Configuring external DNS](https://developers.vtex.com/docs/guides/faststore/go-live-1-configuring-external-dns).
### Production domain
...
In the **Current Domains** section are the default and the primary domains configured for your store.

To verify if your domain is properly configured in the FastStore WebOps environment, navigate to the Settings tab and check if it appears in the **Current Domains** list.
