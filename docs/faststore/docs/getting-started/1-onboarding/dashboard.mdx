...
- [**Production domain**](#production-domain): The primary URL customers use to access the live store.
- [**Secrets**](#secrets): Sensitive information securely managed during the FastStore project deployment process.

![settings-webops](https://vtexhelp.vtexassets.com/assets/docs/src/secrets-webops___2869e469b5a613f389f19cc555f4c3c5.png) 

### Production domain

As part of the go-live process, you must define your store’s production domain.

Before adding the domain, make sure the [external DNS settings](https://developers.vtex.com/docs/guides/faststore/go-live-1-configuring-external-dns) are correctly configured in your VTEX account settings.
...
Secrets, like API keys and passwords, need secure management during FastStore deployment. Standardizing secrets management via WebOps enhances security and consistency across deployment providers.
