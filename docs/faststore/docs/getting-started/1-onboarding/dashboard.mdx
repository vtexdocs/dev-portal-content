...
After the onboarding in the WebOps app, you can access your store through a Live Store URL. You can find the Live Store URL in the VTEX Admin by accessing **Storefront > FastStore WebOps**. In the [**Production Overview**](https://developers.vtex.com/docs/guides/faststore/1-onboarding-dashboard#production-overview) card, locate the **Live Store** URL.
...
The live store ID also helps you [set up the Preview URL in the Headless CMS](https://developers.vtex.com/docs/guides/faststore/headless-cms-1-configuring-the-vtex-account#step-2-configuring-the-headless-cms) so you can preview a page's changes.
