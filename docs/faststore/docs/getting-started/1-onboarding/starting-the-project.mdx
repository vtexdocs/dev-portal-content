...
Connect with a GitHub organization of your choice to host the source code of your FastStore project. 

> ⚠️ FastStore WebOps requires a GitHub organization. You cannot install it in a personal account. Make sure you have Admin access to an organization.

To connect with the GitHub organization, you need to install the FastStore WebOps app in a GitHub organization, by following these steps:
...
2. Once you are logged in to your GitHub account, choose the organization you want to install the app. You will be redirected to the organization **Settings** page on GitHub.
...
The following successful message will appear in the page:

```
Success! You can now close this page and proceed with the onboarding process.
```

After seeing the success message, you can close the tab and continue the onboarding process in the VTEX Admin.

5. Now that the app is integrated with the organization of your choice, select which repository you want to start the project:
...
6. Click `Create`. The deploy process will begin and once the deployment process is complete, you will be redirect to the [Deploy Summary](#deploying-the-project) page.
...
| **View Dashboard**       | Access the Dashboard with the current status of your store, including its domains, deployed versions, store preview, and settings. For more information, please refer to the [Dashboard](https://developers.vtex.com/docs/guides/faststore/1-onboarding-dashboard) guide. |
