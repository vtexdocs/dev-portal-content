...
| Start Project           | Initiates the setup process for creating a new FastStore project. **Users must have the Owner (Admin Super) [role](https://help.vtex.com/en/tutorial/roles--7HKK5Uau2H6wxE1rH5oRbc#roles) to be able to successfully start a new FastStore project**. |
