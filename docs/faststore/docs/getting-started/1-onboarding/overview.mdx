...
### Have a GitHub organization to create your project's repository

During the FastStore WebOps onboarding, you'll need Admin access to a GitHub organization to install the app and create your project's repository. 
If you don't have a GitHub organization, create one by following the official [GitHub documentation](https://docs.github.com/pt/organizations/collaborating-with-groups-in-organizations/creating-a-new-organization-from-scratch).

> ⚠️FastStore WebOps requires a GitHub organization. You cannot install it in a personal account. Make sure you have Admin access to an organization.
