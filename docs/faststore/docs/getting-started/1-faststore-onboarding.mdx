---
title: ' Overview'
slug: 1-faststore-onboarding
---

import { Callout, Tab, Tabs, Steps } from 'nextra-theme-docs'The FastStore Onboarding app simplifies the store setup process, allowing you to focus on building your storefront without dealing with complex configurations. With the app,
...
Please open a ticket with the [VTEX support team](https://help.vtex.com/support) to request the installation of the FastStore Onboarding app.### Create your store Catalog
