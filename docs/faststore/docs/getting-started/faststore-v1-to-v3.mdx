...
- First, migrate the storefront to FastStore v3 in a new subaccount.
- Then, upgrade that v3 project to FastStore v4.

This guide covers [Phase 1](#phase-1-v1-to-v3) of the migration, from FastStore v1 to v3, and links to the detailed instructions for [Phase 2](#phase-2-v3-to-v4).
