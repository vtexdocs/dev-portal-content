...
Recreate all necessary pages, components, and content manually in the Headless CMS for your v3 project. For more information, check [Working with Headless CMS](https://developers.vtex.com/docs/guides/faststore/headless-cms-overview).

> ℹ️ Content migration between v1 and v3 Headless CMS instances isn't supported.
...
## Phase 2 - Upgrading from v3 to v4
