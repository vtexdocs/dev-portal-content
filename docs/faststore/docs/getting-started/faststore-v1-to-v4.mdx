...
> ℹ️ Content migration from Headless CMS (legacy) to the CMS for FastStore storefronts isn't supported. As soon as your subaccount is ready, recreate your Headless CMS (legacy) content directly in the new CMS, since Headless CMS (legacy) is being progressively migrated or deprecated for some accounts.
