...
Now that you have an [overview of the app](/docs/faststore/1-faststore-onboarding-overview), it's time to kickstart your project. In this guide, you will:
...
| **View Dashboard**       | Access a Dashboard with the current status of your store, including its domains, deployed versions, store preview, and settings. You can use this feature to retry a failed deploy or delete the project if necessary. For more information, please refer to the [Dashboard](/docs/faststore/1-faststore-onboarding-dashboard) guide. |

Now that your store is up and running, let's set up the development environment by following the step-by-step instructions in [Setting up the Project](/docs/faststore/getting-started-2-setting-up-the-project).
...
Now that your store is up and running, let's set up your development environment by following the step-by-step instructions in [Setting up the Project](/docs/faststore/getting-started-2-setting-up-the-project).
