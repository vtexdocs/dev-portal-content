...
To migrate your FastStore project to a new repository, see the guide [Migrating your FastStore project to a new repository](https://developers.vtex.com/docs/guides/faststore/getting-started-migrating-your-faststore-project-to-a-new-repository).
