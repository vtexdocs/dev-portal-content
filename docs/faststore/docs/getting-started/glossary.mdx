...
There are two types: [global tokens](https://developers.vtex.com/docs/guides/faststore/using-themes-overview#global-and-local-tokens), which control system-wide interactions and [local tokens](https://developers.vtex.com/docs/guides/faststore/using-themes-overview#global-and-local-tokens), which customize individual components.
...
The process of customizing the appearance of a store by using CSS stylesheets known as [themes](/docs/getting-started-glossary#themes).
