...
There are two types: [global tokens](https://www.faststore.dev/docs/global-tokens/overview), which control system-wide interactions, and [local tokens](https://developers.vtex.com/docs/theming-overview#global-and-local-tokens), which customize individual components.
...
A [Static Site Generator](https://developers.vtex.com/docs/getting-started-glossary#static-site-generator-ssg) created by Vercel for developing React-based web applications server-side rendering and generating static websites.
...
The process of customizing the apperance of a store by using CSS stylesheets known as [themes](https://developers.vtex.com/docs/getting-started-glossary#themes).
