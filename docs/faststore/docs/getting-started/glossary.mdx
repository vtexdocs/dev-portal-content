...
The nature of pages created via the [VTEX Headless CMS](https://developers.vtex.com/docs/headless-cms-overview).
...
[VTEX Headless CMS](https://developers.vtex.com/docs/headless-cms-overview) is a no-code management system for creating, editing and publishing web pages.
