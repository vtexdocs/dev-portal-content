...
| For stores using [CMS](https://developers.vtex.com/docs/guides/cms-for-faststore-storefronts) with custom components | Run the following commands: <ol><li>`vtex login`</li> <li>`vtex content generate-schema cms/faststore/components cms/faststore/pages -o cms/faststore/schema.json -b vtex.faststore`</li> <li>`vtex content upload-schema cms/faststore/schema.json`</li></ol>|
| For stores using [CMS](https://developers.vtex.com/docs/guides/cms-for-faststore-storefronts) without custom components | <ol><li>`vtex login`</li> <li>`vtex content upload-schema node_modules/@faststore/core/cms/faststore/schema.json`</li></ol> |
