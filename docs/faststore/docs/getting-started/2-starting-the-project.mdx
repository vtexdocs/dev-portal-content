...
1. In the **Git Provider** section, you'll see two options:
...
2. Click `Connect with GitHub`. A new browser tab will open on the side for you to integrate the app with GitHub.
    ...
    > ⚠️ If you are not logged in to your GitHub account, you will be prompted to log in in a new tab. Then, you can continue to the next step.
...
3. **Complete the GitHub app installation:**
   ...
   - **For Custom Domain (GitHub Enterprise):** Once you have entered the domain of your GitHub Enterprise instance (for example, `{enterpriseName}.ghe.com`) and clicked `Connect with GitHub`, you'll be redirected to the app creation page for your custom domain. On the page, click `Create GitHub App for Organization` to complete the app creation process.
...
7. Click `Create`. The deployment process will begin, and once it is complete, you will be redirected to the [Deploy Summary](#step-3--deploying-the-project) page.
