...
6. Now that the app is integrated with GitHub, select which repository you want to start the project:
    ...
    - **New repository:** Create a repository from scratch. In this option, you only need to type a repository name, and after clicking `Create`, the repository will be created for you.
