...
>⚠️ For FastStore projects hosted in the `vtex-sites` organization and not using WebOps ([FastStore v1](https://v1.faststore.dev/docs)), open a ticket to [VTEX Support](https://supporticket.vtex.com/support) to move your project to your account's GitHub organization and update it to v3.
