...
updatedAt: "2026-01-06T14:23:13.867Z"
---
...
![secrets-settings-webops](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@EDU-17001/images/webops-settings.gif)

In the [Variable and Secrets](https://developers.vtex.com/docs/guides/faststore/1-onboarding-dashboard#secrets) section, you can [create](#creating-secrets), [update](#updating-secrets), or [delete](#deleting-secrets) variables and secrets following the steps below.
...
>
> If you deployed your storefront immediately after creating, updating, or deleting a variable or secret and the change isn't reflected in your store, wait a few minutes and run another deploy before opening a support ticket.
...
![creating-secrets](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@EDU-17001/images/create-secret.gif)
...
5. Track the deployment status in the [Deploys](https://developers.vtex.com/docs/guides/faststore/1-onboarding-dashboard#deploys) tab of the WebOps dashboard.
  ...
  ![updating-secrets](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@EDU-17001/images/update-secret.gif)
...
6. Track the deployment status in the [Deploys](https://developers.vtex.com/docs/guides/faststore/1-onboarding-dashboard#deploys) tab of the WebOps dashboard.
  ...
  ![deleting-secrets](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@EDU-17001/images/delete-secrets.gif)
