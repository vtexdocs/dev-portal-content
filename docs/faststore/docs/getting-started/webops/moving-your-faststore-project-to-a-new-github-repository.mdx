...
updatedAt: "2026-08-07T19:21:33.276Z"
---

In this guide, you'll learn how to move your FastStore project from one repository to another. You can do this directly from [FastStore WebOps](https://developers.vtex.com/docs/guides/faststore/webops-dashboard) in the following cases:

- Move a FastStore project from its current GitHub organization to a new one.
- Move a FastStore project to a different repository within the same organization.

>⚠️ For FastStore projects hosted in the `vtex-sites` organization, open a ticket with [VTEX Support](https://help.vtex.com/en/support) to move the project to your account's GitHub organization.
...
If you want to move your project to a new organization, make sure you've already created a GitHub organization. To learn how, see the GitHub guide [Creating a new organization from scratch](https://docs.github.com/en/organizations/collaborating-with-groups-in-organizations/creating-a-new-organization-from-scratch).

### Have a GitHub repository

Make sure you've created the GitHub repository where you want to move your FastStore project. To learn how, see the GitHub guide [Creating a new repository](https://docs.github.com/en/repositories/creating-and-managing-repositories/creating-a-new-repository).

>⚠️ The repository change isn't available for **private GitHub instances**. The WebOps dashboard won't display the option if your project is connected to a private GitHub instance.
