...
> ⚠️ For FastStore projects hosted in the `vtex-sites` organization and not using WebOps ([FastStore v1](https://v1.faststore.dev/docs)), open a ticket with the [VTEX Support](https://help.vtex.com/en/support) to move your project to your account's GitHub organization.
