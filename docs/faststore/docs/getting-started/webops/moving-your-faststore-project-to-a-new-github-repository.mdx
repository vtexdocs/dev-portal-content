...
> ⚠️ For FastStore projects hosted in the `vtex-sites` organization and not using WebOps ([FastStore v1](https://v1.faststore.dev/docs)), open a ticket with [VTEX Support](https://help.vtex.com/en/support) to move your project to your account's GitHub organization.
...
2. Click `Configure`.
3. Click the organization where you want to move your project.
