...
The **Git Provider** section lets you configure the GitHub organization and repository associated with your FastStore project. From this section, you can move your project to a different organization or to a different repository within the same organization. For detailed instructions, see [Moving your FastStore project to a new GitHub repository](https://developers.vtex.com/docs/guides/faststore/webops-moving-your-faststore-project-to-a-new-github-repository).
