...
![settings-webops](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@EDU-17950/images/settings-webops.gif)
...
> ℹ️ **FastStore v4** requires **Node.js v24** in WebOps. If you're upgrading from an earlier FastStore major, follow [Upgrading FastStore to v4](https://developers.vtex.com/docs/guides/faststore/getting-started-upgrading-faststore-to-v4), including the WebOps steps after you update your repository and configuration.
