...
The **Current keys** section lists all secrets configured for your store. This list shows each secret's key (identifier). The value is hidden by default for security. You can toggle visibility if needed.
