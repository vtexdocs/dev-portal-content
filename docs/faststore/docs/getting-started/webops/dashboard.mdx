...
* [**Password protection**](#password-protection): Restricts access to preview environments and production domains with username and password authentication.
...
The **Password protection** section allows you to restrict access to your preview environments and production domain by requiring username and password authentication. This is useful for protecting internal testing environments, staging builds, or production domains from unauthorized access during development or initial launch phases.

In the **Password protection** section, you can:

* Enable password protection for preview deployments by toggling the switch
* Enable password protection for your production domain by toggling the switch
* Define a **Username** that will be required to access the protected environment
* Define a **Password** that will be required to access the protected environment

When password protection is enabled, users will be prompted with a basic authentication dialog when accessing the protected environment's URL. They must enter the configured username and password to proceed.

> ℹ️ Password protection settings are applied immediately to all deployments in the selected environment. Ensure you share the username and password with authorized users through a secure channel.
