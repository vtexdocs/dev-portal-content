...
In the **Variables and Secrets** section, fill in the following fields and click `Add`:
...
> ℹ️ Learn more in [Managing variables and secrets](https://developers.vtex.com/docs/guides/faststore/webops-managing-variables-and-secrets).
