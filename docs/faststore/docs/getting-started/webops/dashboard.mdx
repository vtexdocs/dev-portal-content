...
The **Node.js version** configuration defines which Node.js runtime version WebOps uses when it builds your storefront. It doesn't change the Node.js version on your local machine.

When no version has been saved for the project yet, WebOps selects **Node.js v24** for this setting, as this is the default version. After you choose a version and save, WebOps uses that value for builds until you change it and save again. If the field shows `v22`, `v20`, or another supported release, that is the version stored for the project. You should update the field and save when you want builds to run on a different Node.js release.
