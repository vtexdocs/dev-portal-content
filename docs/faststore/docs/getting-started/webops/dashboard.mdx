...
> ⚠️ If you run automated tests against preview URLs, keep in mind that a request made right after 12 hours of inactivity may not immediately return the storefront, since the preview could still be waking up. Add a retry to your test setup to account for this.
