...
* **Custom domains (e.g. www.mystore.com):** Applies password protection to your public-facing store domain configured in FastStore (for example, www.mystore.com). Select this option when you want to temporarily gate access to your production site or a custom staging domain during soft launches, QA, or controlled rollouts. To enable password protection for custom domains, open a ticket with [VTEX Support](https://help.vtex.com/en/support).
