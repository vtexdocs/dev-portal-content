---
title: 'Requirements'
excerpt: "This guide provides the requirements before starting a FastStore project."
updatedAt: "2025-09-09T10:00:00.813Z"
---

Before starting a FastStore project, you must have the necessary tools and apps installed in your VTEX account. This guide walks you through the required steps.

## 1. Installing VTEX IO CLI on your machine

The VTEX IO CLI is the command-line interface you'll use to manage your VTEX projects. If you haven't already done so, install it on your machine. For detailed instructions, refer to the [this guide](https://developers.vtex.com/vtex-developer-docs/docs/vtex-io-documentation-vtex-io-cli-installation-and-command-reference).

## 2. Installing Headless CMS and its dependencies

[Headless CMS](https://developers.vtex.com/docs/guides/faststore/headless-cms-overview) is the content management solution for FastStore projects. During the [Onboarding](https://developers.vtex.com/docs/guides/faststore/getting-started-overview), the integration between your project and Headless CMS is initiated.
...
If yes, proceed to check the [next requirement](https://developers.vtex.com/docs/guides/faststore/getting-started-requirements#3-installing-headless-cms-plugins). If not, continue following these instructions.
...
Once the app and its dependency are installed, proceed to check the [next requirement](https://developers.vtex.com/docs/guides/faststore/getting-started-requirements#3-installing-headless-cms-plugins).

## 3. Installing Headless CMS plugins
...
## 4. Enabling the VTEX Intelligent Search app in your account
...
To enable the app, check the version of your [Edition Store](https://developers.vtex.com/docs/guides/vtex-io-documentation-edition-app) account.
...
To integrate the VTEX Intelligent Search, go to the VTEX Admin, access **Store Settings > Intelligent Search > Integrations**, and click `START INTEGRATION`.
...
After successfully installing the app, integrate it by accessing the VTEX Admin, go to **Store Settings > Intelligent Search > Integrations**, and click `START INTEGRATION`.

### Accounts that want to migrate to the `5.x`</summary>
...
## 5. Installing the FastStore WebOps app

The [FastStore WebOps app](https://developers.vtex.com/docs/guides/faststore/1-onboarding-overview) is the first step in creating, setting up, and managing your FastStore project. It also provides deployment and performance insights into your website.
...
1. In a terminal, log in to your VTEX account by running the following. Replace `{accountName}` with your store account name, for example, `vtex login store`.
