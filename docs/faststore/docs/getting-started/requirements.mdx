...
[Open a ticket with the VTEX support team](https://help.vtex.com/support) and request the installation of the [FastStore Onboarding](https://developers.vtex.com/docs/guides/faststore/getting-started-overview) app.
