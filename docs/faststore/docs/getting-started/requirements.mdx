...
The [Headless CMS](https://developers.vtex.com/docs/guides/faststore/docs-headless-cms-overview) is the content management solution for FastStore projects. During the [Onboarding](https://developers.vtex.com/docs/guides/faststore/1-faststore-onboarding-overview),
...
`vtex.admin-cms-graphql` and `vtex.admin-cms-graphql-rc`. To check wether you have the them installed, refer to [Installing the Headless CMS app](https://developers.vtex.com/docs/guides/faststore/docs-getting-started-requirements#installing-the-headless-cms-app-and-its-dependencies).
