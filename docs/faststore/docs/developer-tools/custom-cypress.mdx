...
> ℹ️ To learn how these tests fit into a broader quality gate, see [Continuous integration for FastStore projects](https://developers.vtex.com/docs/guides/faststore/developer-tools-continuous-integration).
...
- Make sure you're using `@faststore/cli` version `2.2.9` or above. If you have versions older than the requirement, update them following the instructions in [Updating the '@faststore/cli' package version](https://developers.vtex.com/docs/guides/faststore/developer-tools-updating-the-cli-package-version).
---
