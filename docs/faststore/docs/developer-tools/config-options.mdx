...
Defines which pages [Cypress](https://docs.cypress.io/app/get-started/why-cypress) end-to-end tests target. Map URLs under the `pages` object so test suites run reliably on deployment and updates. Example:
