...
| [`minPriceAmountFractionDigits`](/docs/guides/faststore/seo-configuring-product-price-meta-tag-on-pdp) | `number` | Minimum fraction digits used in the PDP `product:price:amount` meta tag. | `2` |
