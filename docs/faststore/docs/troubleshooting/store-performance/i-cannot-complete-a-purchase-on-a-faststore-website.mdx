...
When trying to complete a purchase on your FastStore website, you can receive the following error message: `This Connection Is Not Private`

![not-secure-faststore](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/faststore/docs/troubleshooting/store-performance/not-secure-faststore.png)
...
![dns-checker](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main//docs/faststore/docs/troubleshooting/store-performance/secure-hostname-2.png)
