...
**Check if the bug you are facing is a Starter bug**. Please refer to the [Identifying development errors and Starter bugs](https://developers.vtex.com/docs/guides/faststore/identifying-development-errors-and-starter-bugs) guide for more information.
