---
title: "Icons"
excerpt: "This set of icons uses SVGs from Phosphor icons."
---

Icons help build web pages by illustrating concepts and improving website navigation.FastStore offers a set of icons that our components use, and you can also use them on your application. This set of icons uses SVGs from [Phosphor icons](https://phosphoricons.com/).
...
You can find more details about the `Icon` component [here](/docs/guides/faststore/atoms-icon).
...
<IconList>
  ...
  <IconComponent icon={<Icon name="Envelop" />} name="Envelope" />
</IconList>
