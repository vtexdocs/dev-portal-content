...
> ⚠️ Currently, FastStore stores are having issues receiving Google Tag Manager events due to integration between FastStore and [Partytown](https://partytown.builder.io/). The team is already investigating to fix it. Meanwhile, Refer to the workaround available in the [known issue article](https://help.vtex.com/en/known-issues/gtm-scripts-are-not-loading-on-the-native-thirdparty-scripts--4hTYThw8092OCHhUIvpCAa).
