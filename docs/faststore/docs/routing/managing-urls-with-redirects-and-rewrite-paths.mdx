...
?>ℹ️ For more information on how to manage a page in the Headless CMS, see the see the [Managing pages in the Headless CMS](https://newhelp.vtex.com/en/docs/tutorials/managing-pages).
