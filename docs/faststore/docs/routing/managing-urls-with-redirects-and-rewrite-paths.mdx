...
In this guide, you will learn how to configure redirects and rewrites in your FastStore project. This enables you to effectively manage user access to your content by automatically directing users from one URL to another or mapping custom URLs to existing page templates.
...
Before configuring redirects, it's important to understand how the redirect feature behaves in FastStore and its limitations.
