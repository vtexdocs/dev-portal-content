...
Gathers the design system based on FastStore components, using [Sass](https://sass-lang.com/) for styling. For more information, refer to the [FastStore UI](/docs/guides/faststore/components-index) guide.
...
<Flex>
  ...
  linkTo="/docs/guides/faststore/docs-getting-started-overview"
  linkTitle="See more"
  />
  ...
  linkTo="/docs/guides/faststore/themes-overview"
  linkTitle="See more"
  />
  ...
  linkTo="/docs/guides/faststore/docs-headless-cms-overview"
  linkTitle="See more"
  />
