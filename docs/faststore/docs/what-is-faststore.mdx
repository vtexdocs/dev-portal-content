...
<Flex>
  ...
  linkTo="https://developers.vtex.com/docs/guides/faststore/docs-headless-cms-overview"
  linkTitle="See more"
  />
  ...
  linkTo="https://developers.vtex.com/docs/guides/faststore/building-sections-component-customization-overview"
  linkTitle="See more"
  />
