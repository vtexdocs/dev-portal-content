...
slug: what-is-faststore
---

<header className="hero">The ultimate toolkit for building blazing-fast storefronts.## What is FastStore?
...
| **Search**    | Handles the state of the faceted search (e.g., apply filters and sort).          |Our SDKs also provide GA4 compatible analytics functions to help you create powerful analytics capabilities in your ecommerce.
...
Gathers the design system based on FastStore components, using [Sass](https://sass-lang.com/) for styling. For more information, refer to the [FastStore UI](/docs/guides/faststore/) guide.
...
<ul class="nx-card-list">
  ...
  <li class="nx-card">
    <a href="/docs/guides/faststore/themes-overview">
      #### Theming
