...
2. **Module type**: The module you want to initialize (`discovery`, `checkout`, or `sales-app`). For `checkout` and `sales-app`, continue with [Setting up Buyer Portal Checkout](https://developers.vtex.com/docs/guides/setting-up-buyer-portal-checkout) or [Setting up Sales App extensions](https://developers.vtex.com/docs/guides/setting-up-sales-app-extensions) after you create the project.
