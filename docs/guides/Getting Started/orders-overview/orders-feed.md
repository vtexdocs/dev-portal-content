...
updatedAt: "2022-05-02T21:51:52.791Z"
---
...
```
(salesChannel != "3" and sellers.id ="sellerId")
```
...
Here are two complete example bodies for the Feed configuration request, using each of the `filter` types:
...
![FeedFlow-min](//images.contentful.com/alneenqid6w5/1zmHKKb9wsgG6ssmy66Cs8/28b245360fba6b59390c7a440c50d8eb/FeedFlow-min.png)
