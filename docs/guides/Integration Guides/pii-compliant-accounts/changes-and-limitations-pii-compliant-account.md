...
In order to integrate with the [Profile System](https://developers.vtex.com/vtex-rest-api/docs/profile-system) and [manage your customers’ information](https://developers.vtex.com/vtex-rest-api/docs/data-privacy), see in this article the changes and limitations you must make.
