...
>ℹ️ The following diagrams represent one single VTEX account and assume that the customer is using [Store Framework](https://developers.vtex.com/docs/guides/store-framework) as a storefront solution.
