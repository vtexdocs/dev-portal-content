...
![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-0_26.png)

3. Select **Identifiers**.

![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-1_30.png)

4. Next to Identifiers, click on the blue **+** button.

![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-2_34.png)

5. Select the **Merchant IDs** option.
6. Click on the blue **Continue** button.

![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-3_39.png)

7. Fill on the **Description** field.
8. Fill in the **Identifier** field.
9. Click on **Continue**.

![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-4_45.png)
...
![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-5_61.png)

2. Type in your newly created **Merchant ID** in the search bar.
3. Select the desired **Merchant ID**.

![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-6_66.png)

4. Under **Apple Pay Payment Processing Certificate**, click the **Create Certificate** button.

![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-7_70.png)
...
![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-8_74.png)
...
![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-9_88.png)

4. Click on **Download**.

![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-10_92.png)
...
![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-11_114.png)

2. Click on the desired **MerchantID**.
3. In the **Merchant Domain** module, click on **Add Domain**.

![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-12_119.png)
...
![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-13_128.png)
...
![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-14_142.png)
...
![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-15_163.png)

4. Select the desired **Merchant Identifier**.
5. Click on **Create Certificate**.

![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-16_168.png)

6. Follow the **instructions** displayed on the screen to create a certificate.
7. Click on **Continue**.

![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-17_173.png)

8. Click on **Download**.

![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-18_177.png)
...
![](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/guides/Payments/payments-configuration-guides/setting-up-merchant-id-in-apple-pay-19_186.png)
