...
Follow the steps below to access this resource:
...
> ℹ️ If any of the apps above are not installed in your store, update only the ones you have.
...
>⚠️ To revert to a previous version, reinstall the earlier versions of each app.
