...
| ViewUsers | Grants read-only access to view user details and listings. |
...
| ViewAccountingFields | Grants read-only access to view accounting field configurations. |
| ManageCreditCards | Allows management of saved credit cards, including adding, editing, and removing cards. |
| ViewCreditCards | Grants read-only access to view saved credit cards. |
...
| ViewAddresses | Allows users to view their saved addresses. |
...
| :---- | :---- | :---- | :---- | :---- |
| Organizational Unit Admin | 1 | Manages the organization's structure, contracts, and related settings. | ManageOrganizationAndContract, ManageUsers, ViewUsers, ManageBuyingPolicies, ViewBuyingPolicies, ManageBudgets, ViewBudget, ManageAccountingFields, ViewAccountingFields, ManageCreditCards, ViewCreditCards | UI and API |
...
| Accounting Field Manager | 13 | Can create, edit, and delete accounting fields, and view accounting field configurations. | ManageAccountingFields, ViewAccountingFields | API only |
