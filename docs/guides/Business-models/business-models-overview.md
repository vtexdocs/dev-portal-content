...
For more information, see [Implementing internationalization](https://developers.vtex.com/docs/guides/implementing-internationalization).
...
For more information, see [Implementing cross-border stores](https://developers.vtex.com/docs/guides/implementing-cross-border-stores).
...
For more information, see [Implementing marketplaces](https://developers.vtex.com/docs/guides/implementing-marketplaces).
...
<Flex>
  ...
  <WhatsNextCard
    ...
    description="Learn how to prepare your store to operate in multiple languages and locales."
    linkTo="/docs/guides/implementing-internationalization"
    linkTitle="See more"
  />

  <WhatsNextCard
    title="Implementing cross-border stores"
    description="Learn how to structure and start a cross-border operation on VTEX."
    linkTo="/docs/guides/implementing-cross-border-stores"
    linkTitle="See more"
  />

  <WhatsNextCard
    title="Implementing marketplaces"
    description="Compare marketplace implementation scenarios and choose the right integration path."
    linkTo="/docs/guides/implementing-marketplaces"
    linkTitle="See more"
  />
