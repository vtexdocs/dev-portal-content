...
To retrieve published content through generic or schema-generated GraphQL fields, see [Data Plane GraphQL API](https://developers.vtex.com/docs/guides/using-the-cms-graphql-api).
