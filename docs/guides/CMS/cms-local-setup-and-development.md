---
title: "CMS local setup and development"
hidden: false
slug: "cms-local-setup-and-development"
...
After completing the [Getting started with CMS](/TBD) guide, you can start adding and updating the component schemas that define what content editors can manage in the CMS Admin.
