...
> ℹ️ It is not possible to create a new layout to be used in custom payment methods (those developed by the merchant and that only work in their stores, such as notes payable, co-branded or private label cards).
