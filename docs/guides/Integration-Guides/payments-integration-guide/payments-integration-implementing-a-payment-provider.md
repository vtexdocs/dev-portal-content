...
> ℹ️ This flow is optional and doesn't affect the integration with VTEX. If you don't plan to implement it, skip to the [Homologation](https://developers.vtex.com/docs/guides/payments-integration-payment-provider-homologation) section.
...
> ⚠️ The `applicationId` value is always `"vtex"`.
