...
> ⚠️ IO apps do not work in headless environments. If you want to process payments in this type of scenario, you must use a checkout [webview](https://en.wikipedia.org/wiki/WebView) or implement a fully headless integration directly between your system and the acquirer/connector, sending the information via custom payments or promissory notes.
