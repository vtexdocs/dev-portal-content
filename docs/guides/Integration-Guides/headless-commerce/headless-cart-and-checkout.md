...
In the Checkout API, the VTEX shopping cart information is organized using the [orderForm](https://developers.vtex.com/docs/guides/orderform-fields), an object containing all information relevant to the purchase, from the products to shipping and payment information, among others.
