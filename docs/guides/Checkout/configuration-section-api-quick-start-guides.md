...
---
This section contains the quick start guides of the endpoints described in the [Configuration section](https://developers.vtex.com/docs/api-reference/checkout-api#configuration) of the Checkout API Reference.
