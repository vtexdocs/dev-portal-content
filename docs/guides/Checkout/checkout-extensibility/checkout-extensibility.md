...
Checkout Extensibility lets you extend the default Checkout journey with capabilities aligned to your business model, such as external integrations and custom UX/UI. Using extension points across all Checkout stages (Cart, Delivery, Review, Payment, and Order Placed), you can render your own components without changing Checkout's core behavior.
