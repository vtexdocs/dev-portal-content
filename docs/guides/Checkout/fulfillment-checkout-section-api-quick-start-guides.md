...
updatedAt: ""
---
This section contains the quick start guides of the endpoints described in the [Fulfillment section](https://developers.vtex.com/docs/api-reference/checkout-api#fulfillment) of the Checkout API Reference.
