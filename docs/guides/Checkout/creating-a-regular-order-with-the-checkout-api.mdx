...
```shell Shell mark=2[17:29],2[72:86],2[105:113],4[31:38],5[33:42],6[10:407]
curl --request post \
...
```python Python mark=3[37:49],9[25:32],10[27:36],13[45:59],13[78:86]
import http.client
...
```js Node.js mark=5[15:27],10[25:32],11[27:36],29:48,7[33:47],7[66:74]
const http = require("https");
