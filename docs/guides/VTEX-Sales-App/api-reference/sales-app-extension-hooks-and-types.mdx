...
The `defineExtensions` function registers one or more React components by associating them with the [Exploring Sales App extensions](https://developers.vtex.com/docs/guides/exploring-sales-app-extensions).
