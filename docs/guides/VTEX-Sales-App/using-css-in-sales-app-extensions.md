...
hidden: false
excerpt: "Learn how about CSS for VTEX Sales App Extensibility."
...
- Using [`cssmodules`](https://github.com/css-modules/css-modules) to access classes through the object automatically generated by the bundler.
...
> ⚠️ However, regardless of how you choose to import, this technique generates globally scoped CSS class names, meaning they can conflict with other extensions you're styling. On the other hand, Sales App itself generates classes with unique IDs, so there is no conflict with the core.
