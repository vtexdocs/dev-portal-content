...
- [Sales App extensions implementation](https://developers.vtex.com/docs/guides/sales-app-extensions-implementation) — Know which content to read to implement, deploy, and reference VTEX Sales App extensions:
