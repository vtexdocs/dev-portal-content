...
## When to use the Extensions Skill

Use this skill when building, customizing, or deploying extensions for Sales App for:

- ✅ Adding features to the cart page (promotions, loyalty, services).
- ✅ Adding features to Product Detail Pages (badges, recommendations, warranties).
...
The `sales-app-extensibility` skill is part of the [VTEX Skills](https://developers.vtex.com/docs/guides/vtex-skills) collection. For more information, see the [VTEX Skills source code](https://github.com/vtex/skills) for installation instructions.
