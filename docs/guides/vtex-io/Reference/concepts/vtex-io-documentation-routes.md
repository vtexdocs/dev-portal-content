...
> ℹ️ A path can accept URL parameters and optional parameters as in: `/path/:param(/:optional-param)`. However, we recommend keeping it simple, as paths for custom pages are the ones used on the client-side and by search engines.
