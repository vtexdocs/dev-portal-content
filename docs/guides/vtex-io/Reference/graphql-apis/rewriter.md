...
---
Rewriter is the VTEX IO app responsible for managing the following three main types of [routes](https://developers.vtex.com/docs/guides/vtex-io-documentation-routes): product, search, and navigation routes.
