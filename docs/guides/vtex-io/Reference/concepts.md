...
---
## [Billing Options](https://developers.vtex.com/docs/guides/vtex-io-documentation-billing-options)
...
## [CMS](https://developers.vtex.com/docs/guides/store-framework-working-with-site-editor)
...
## [Edition App](https://developers.vtex.com/docs/guides/vtex-io-documentation-edition-app)
...
## [Peer Dependencies](https://developers.vtex.com/docs/guides/vtex-io-documentation-peerdependencies)
...
## [Roles](/docs/guides/vtex-io-documentation-roles)

**Roles** are uniquely identifiable names given to request sources.

## [Routes](https://developers.vtex.com/docs/guides/configuring-dynamic-routes-in-vtex-io-services)
...
## [Slots](https://developers.vtex.com/docs/guides/vtex-io-documentation-slots)
...
## [VTEX Resource Name (VRN)](https://developers.vtex.com/docs/guides/vtex-io-documentation-vrn)
