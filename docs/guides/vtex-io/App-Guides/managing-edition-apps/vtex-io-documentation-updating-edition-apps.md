...
> Notice that an Edition app version is updated only if its major version has not been changed, meaning it is not a breaking change for the child accounts consuming that Edition.

If bumping the major version is necessary due to the changes made, the Edition update must be performed manually and individually for each child account.
