...
Now that we are actively using the data retrieved from Analytics, the next crucial step is to persist and update this data. To achieve this, we'll leverage [Master Data](https://developers.vtex.com/docs/guides/master-data-introduction), a database-as-a-service product from VTEX.
