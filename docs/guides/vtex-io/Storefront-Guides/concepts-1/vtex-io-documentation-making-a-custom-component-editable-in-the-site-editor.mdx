...
- Check if the [Builders](https://developers.vtex.com/docs/guides/vtex-io-documentation-builders) are properly installed in your Store Theme. You must have at least the following builders configured:
    ...
    - [react builder](https://developers.vtex.com/docs/guides/vtex-io-documentation-react-builder): Allows developing [React](https://react.dev/) frontend components. 
...
By setting `CustomComponent` as the default export, you can import it into other parts of the app or other apps.
