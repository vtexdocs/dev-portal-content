...
hidden: false
createdAt: "2024-06-17T20:45:34.646Z"
updatedAt: "2024-06-17T20:45:34.646Z"
...
2. Open the `index.tsx` file and define your custom component as in the following steps.
...
### Step 2 - Defining the component's interface
...
### Step 4 - Defining the component's props
...
In the app's repository where you are developing your custom component, open the `interfaces.json` file within the `/store` folder. Declare the schema definitions for your component as follows:
...
### Step 8 - Using the component within a store page
