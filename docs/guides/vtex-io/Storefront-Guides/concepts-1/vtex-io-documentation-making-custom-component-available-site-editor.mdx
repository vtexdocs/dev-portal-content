...
1. Create a new folder in the `/react` root directory. Follow the pattern `react/components/{ComponentName}/index.tsx`.

    For example, for a component named `CustomComponent`, the folder structure is as follows:
