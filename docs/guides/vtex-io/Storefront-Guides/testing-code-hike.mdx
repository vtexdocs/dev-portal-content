...
![custom-component](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@testing-code-hike/ ) | ![schema-custom-component](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@testing-code-hike/ )
:--- | ---: 
