...
> ℹ️ *Although support for the former version is still granted, we strongly recommend that you update your store theme with the app's newest version in order to keep up with the components' evolution.*
