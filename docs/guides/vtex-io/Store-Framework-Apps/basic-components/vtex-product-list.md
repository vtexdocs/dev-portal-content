...
| `product-quantity-label`       | Renders a product label that displays the quantity of units added to the cart.                                                                                                                                                                                                                  |
| `quantity-selector`            | Renders a selector that allows users to add a chosen number of a product to their cart.                                                                                                                                                                                                                |
...
| `lazyRenderOffset` | `number` | The distance (px) to the bottom of the viewport that each item should be at the moment of its render.                                                                                                                                                                                                                                                                                                                                                                                                | `300`         |
