...
| `MinicartIcon`         | `block`            | Icon displayed in the Minicart button. This prop's value must match the name of the block responsible for rendering the desired icon.                                                                                                                                                                                                                                                                                                                 | `icon-cart` (from [Store Icons](https://developers.vtex.com/docs/guides/vtex-store-icons/) app) |
...
For further information on how to configure each of the blocks used to compose `minicart.v2` , check out [Product List](https://developers.vtex.com/docs/apps/vtex.product-list) and [Checkout Summary](https://developers.vtex.com/docs/apps/vtex.checkout-summary).
