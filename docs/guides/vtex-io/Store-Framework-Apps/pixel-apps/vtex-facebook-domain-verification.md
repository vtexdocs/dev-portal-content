...
> ℹ️️ Access the [Facebook Business Settings](https://business.facebook.com/settings/owned-domains/) and log in to your account to find your domain verification code. Click on the Meta-tag Verification tag and copy only the code inside the content attribute.
