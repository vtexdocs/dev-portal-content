...
> ℹ️ Once the app is installed in your account, the `checkout6-custom.js` and `checkout6-custom.css` files will be replaced by the ones generated by this app.

## Behavior

If you access your VTEX account's Admin using a [Development workspace](https://developers.vtex.com/docs/guides/vtex-io-documentation-workspace) and publish your changes, the configurations performed using the app will only be applied to the workspace you are working in and not to your store Checkout.
...
If you want to insert other content, make sure to include the class `.v-custom-mhide` to hide it on mobile resolutions. For example:
...
<details>
  <summary>If you are still using the classic CMS</summary>
  You can create a workspace and install the app there. While using the app, you will need to apply your changes and copy and paste the content of the files to your portal.
</details>
