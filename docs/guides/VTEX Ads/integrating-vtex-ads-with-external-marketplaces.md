...
> ℹ️ Access credentials must be requested from our [Support](https://support.vtex.com) team.
...
For the full request and response specification, see [Generate seller single sign-on URL](https://developers.vtex.com/docs/api-reference/vtex-ads-api#post-/sso/marketplace) in the VTEX Ads API reference.
