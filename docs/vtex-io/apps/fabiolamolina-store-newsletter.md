...
slug: "fabiolamolina-store-newsletter"
excerpt: "fabiolamolina.store-newsletter@2.0.0"
hidden: true
createdAt: "2022-08-02T12:20:32.961Z"
updatedAt: "2022-08-02T13:05:03.389Z"
---
<!-- DOCS-IGNORE:start -->
...
| `typeSubscribeMutation`   | `enum`            | Enum to selected type of request to use for register the API to save a newsletter data. Choice betewen `profileSubscribe` or `safedataSubscribe`  | `profileSubscribe`   |
