---
title: "Menu"
slug: "simplesreserva-menu"
excerpt: "simplesreserva.menu@0.1.0"
hidden: true
createdAt: "2022-07-21T18:48:04.642Z"
updatedAt: "2022-07-21T18:48:04.642Z"
---
...
```json
  "dependencies": {
    "simplesreserva.menu": "2.x"
  }
```

2. Add the `simplesreserva.menu@2.x:menu` block to the [store header](https://github.com/vtex-apps/store-header/blob/master/store/interfaces.json) template.

3. To build the store's menu options, you need to configure the `menu-item` blocks. These can be declared in two different ways in `simplesreserva.menu@2.x:menu`: as children or as props. The advantage of this latest `menu-item` configuration compared is that Site Editor can be used to edit the blocks.
...
```json
"simplesreserva.menu@2.x:menu#websites": {
  "children": [
    "menu-item#shop",
    "menu-item#about-us"
  ]
...
"menu-item#shop": {
  ...
  "blocks": ["simplesreserva.menu@2.x:submenu#shop"] // Defining a submenu
},
"simplesreserva.menu@2.x:submenu#shop": {
  "children": [
    "simplesreserva.menu@2.x:menu#submenushop"
  ]
},
"simplesreserva.menu@2.x:menu#submenushop": {
  "children": [
