---
title: "SKU Selector"
slug: "coliseumstorecl-store-components-custom-skuselector"
excerpt: "coliseumstorecl.store-components-custom@3.5.8"
hidden: true
createdAt: "2022-07-27T16:30:09.108Z"
updatedAt: "2022-08-01T20:08:39.526Z"
---
...
| `hideImpossibleCombinations`     | `boolean`   | Whether a product variation that leads to an impossible product combination should be clickable (`true`) or not (`false`). If the prop is set to `true`, the variation won't be displayed. However, when the prop is set as `false`, the variation is displayed with less opacity. | `true`  |
