...
slug: "soulcycles-similar-products-variants"
excerpt: "soulcycles.similar-products-variants@0.1.1"
hidden: true
createdAt: "2022-07-18T07:46:11.144Z"
updatedAt: "2022-07-18T07:46:11.144Z"
---
...
```bash
vtex install soulcycles.similar-products-variants
```
2. Add the `soulcycles.similar-products-variants` app to your theme's dependencies in the `manifest.json`

```json
"dependencies": {
    "soulcycles.similar-products-variants": “0.x”
}
```
