...
slug: "lojaiwannasleep-seller-selector"
excerpt: "lojaiwannasleep.seller-selector@0.9.0"
hidden: true
createdAt: "2022-08-04T13:55:26.432Z"
updatedAt: "2022-08-04T13:55:26.432Z"
---
...
| `seller-name` | Displays the seller name. (you can use [markers](https://developers.vtex.com/vtex-developer-docs/docs/vtex-product-price#step-3---editing-the-blocks-messages)|
...
| `seller-installments-list` |Renders all the installments of the payment system with the biggest amount of installments options. |
| `seller-installments-list-item`| Renders an installments option of the `product-installments-list-item`
