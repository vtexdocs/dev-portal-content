...
slug: "jumbocolombiaio-auth-service"
excerpt: "jumbocolombiaio.auth-service@1.3.0"
hidden: true
createdAt: "2022-07-17T23:34:43.291Z"
updatedAt: "2022-07-17T23:34:43.291Z"
---
...
Koa uses the [path-to-regexp](https://github.com/pillarjs/path-to-regexp) format for defining routes and, as seen on the example, we use the `:code` notation for declaring a **route param** named code, in this case. A HTTP request for `https://production--{{account}}.myvtex.com/_v/status/500` will match the route we've defined. 
