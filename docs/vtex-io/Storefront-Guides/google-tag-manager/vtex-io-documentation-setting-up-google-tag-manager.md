...
1. Download the [container file](/docs/vtex-io/Storefront-Guides/google-tag-manager/container-template.json). This container adds all the necessary tags, triggers, and variables.
