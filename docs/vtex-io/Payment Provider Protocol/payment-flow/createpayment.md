...
updatedAt: "2021-06-22T22:41:47.927Z"
---
...
<table>
  ...
  <tr>
    ...
    <tr>
        ...
        <td>string</td>
        <td>Yes</td>
        <td>One of the available payment methods listed above</td>
    </tr>
    <tr>
...
<tr>
   ...
   <tr>
    ...
    <tr>
        ...
        <td>object</td>
        <td>Yes</td>
        <td>Object containing the card information</td>
    </tr>
    <tr>
 ...
 <tr>
        ...
        <td>string</td>
        <td>Yes</td>
        <td>Buyer's corporate name</td>
    </tr>
 <tr>
        <td>&nbsp;&nbsp;&nbsp;&nbsp; &#x21B3; <code>tradeName</code></td>
        <td>string</td>
        <td>Yes</td>
        <td>Buyer's trade name</td>
    </tr>
 <tr>
        <td>&nbsp;&nbsp;&nbsp;&nbsp; &#x21B3; <code>corporateDocument</code></td>
        <td>string</td>
        <td>Yes</td>
        <td>Buyer's corporate document number</td>
    </tr>
 <tr>
        <td>&nbsp;&nbsp;&nbsp;&nbsp; &#x21B3; <code>isCorporate</code></td>
        <td>boolean</td>
        <td>Yes</td>
        <td>Indicates whether or not the buyer is corporate</td>
    </tr>
    <tr>
...
<tr>
 ...
 <tr>
    ...
    <tr>
        ...
        <td>string</td>
        <td>Yes</td>
        <td>The URL you need to call to send the callbacks/notifications of payment status changes</td>
    </tr>
    <tr>
...
<tr>
    ...
    <tr>Pix Sucess Aprroved request example in the end f the page
        <td>&#x21B3; <code>payload</code></td>
        <td>string</td>
        <td>Yes</td>
...
> If you return a payment with `status` as `undefined`, you're expected to send us a callback/notification to update it later, sending a `POST` with an updated version of your response (same structure as above) to the `callbackUrl` we have provided.
> 
