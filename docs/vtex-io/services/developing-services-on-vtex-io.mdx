...
Inside the `/node` folder of a service there is a `service.json` file, where it's possible to declare routes that the service must respond to and other configurations like timeout and memory.
