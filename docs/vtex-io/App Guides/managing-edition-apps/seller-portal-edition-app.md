...
{
  "type": "info",
  "body": "It is not possible to create edition apps without a VTEX account as the sponsor."
}
[/block]
...
{
  "type": "info",
  "body": "To know which edition is associated with an account, on VTEX Toolbelt, run `vtex edition get`."
}
[/block]
