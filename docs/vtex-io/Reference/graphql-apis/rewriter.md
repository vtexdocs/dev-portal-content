...
<td>Provides <i>redirect</i> routes data.<br></br>Redirect routes are used to redirect a route from one path to another.</td>
</tr>
<tr>
<td colspan="1" valign="top"><strong>internal</strong></td>
<td valign="top"><a href="#queryinternal">QueryInternal</a>!</td>
<td>Provides <i>internal</i> routes data.<br></br>Internal routes are navigation routes.</td>
</tr>
</tbody>
</table>
...
<br></br>Redirect routes are used to redirect a route from one path to another.</td>
</tr>
<tr>
<td colspan="1" valign="top"><strong>internal</strong></td>
...
<br></br>Internal routes are navigation routes.</td>
</tr>
</tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>The argument used to fetch more internal routes from <i>ListRedirectsResponse</i>.<br></br>It must be empty in the first query and, in the following, filled in with the string previously obtained from the <i>ListRedirectsResponse</i> object.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td valign="top">String</td>
            <td>The argument used to fetch more internal routes from <i>ListInternalsResponse</i>.<br></br>It must be empty in the first query and, in the following, filled in with the string previously obtained from the <i>ListInternalsResponse</i> object.</td>
        </tr>
        <tr>
...
<br></br>For VTEX IO pre-defined routes, the <code>declarer</code> value is <code>vtex.store@2.x.</code></td>
</tr>
<tr>
...
<td valign="top">String!</td>
<td>The id of the <i>binding</i> which the route is available.<br></br><i>Keep in mind: Every store has a binding id related to its store locale. Hence, cross-border stores always have more than one binding, while accounts with a single storefront have only one binding id.</i></td>
</tr>
<tr>
<td colspan="1" valign="top"><strong>endDate</strong></td>
<td valign="top">String</td>
<td>The date a route stops being valid.<br></br><i>Keep in mind: The <code>endDate</code> value for permanent routes is <code>null</code>.</i></td>
</tr>
<tr>
...
<td valign="top">String</td>
<td>Alias paths of a route, meaning that the route will resolve the paths defined in the <code>resolveAs</code> field.<br></br><i>Keep in mind: The <code>resolveAs</code> parameter must always be defined in the catalog's default language.</i></td>
</tr>
<tr>
...
<td valign="top">String</td>
<td>Returns a string to be used as the <i>next</i> argument of the succeeding <i>listInternals</i> query to fetch more data.<br></br>When <i>next</i> returns <i>null</i>, all data have already been fetched.</td>
</tr>
</tbody>
</table>
