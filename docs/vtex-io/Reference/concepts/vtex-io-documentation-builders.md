...
---- | ------------- | --------- |
 ...
 `docs` | Allows developers to publish documentation from the `/docs` directory in our Developer Portal. *You can learn how to use it by accessing the recipe on [Using the Docs Builder to publish app documentation](https://developers.vtex.com/docs/guides/using-the-docs-builder-to-publish-app-documentation/).*| ❌ |
