...
The following table outlines the main differences between VTEX’s FastStore, Store Framework, and Legacy CMS Portal.
...
| **Availability**<br><br>_It is possible to have both FastStore and Store Framework running simultaneously in your store, as the environments are totally different._ | General availability.<br><br>For information on unavailable features, see [Business models](#business-models) and [Features and Functionalities](#features-and-funcionalities) topics. | General availability. | No longer available to new stores starting with VTEX. |
...
VTEX platform supports the configuration of different business models, such as Business-to-business (B2B), Marketplaces, Omnichannel, and Internationalization. See below the availability for each storefront technology.
...
✅ **Available:** It is an out-of-the-box feature, ready to use.
⚠️** Limited:** The feature is possible but needs custom implementation.
❌ **Not available:** At the moment, it is not possible to use this feature even with customizations.
...
| **Support to** [**VTEX IO frontend apps**](https://developers.vtex.com/docs/guides/vtex-io-documentation-1-developing-storefront-apps-using-react-and-vtex-io) | ❌   | ✅   | ❌   |
...
| [**Rating & Reviews**](https://developers.vtex.com/docs/apps/vtex.reviews-and-ratings) | ⚠️  | ✅   | ❌   |
...
Learn more at [Developer experience](https://developers.vtex.com/docs/guides/developer-experience).
