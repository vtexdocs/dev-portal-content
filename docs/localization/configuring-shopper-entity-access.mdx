...
To display shopper information on My Account pages, such as the details shown in the **Ordered by** card on the order details page, you must configure the required permissions and API credentials.
