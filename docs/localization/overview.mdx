...
## Next steps
 ...
 To enable the experimental My Account feature in your B2B FastStore store, follow the instructions in the guide [Enabling My Account for B2B stores](https://developers.vtex.com/docs/guides/faststore/my-account-enablement).
