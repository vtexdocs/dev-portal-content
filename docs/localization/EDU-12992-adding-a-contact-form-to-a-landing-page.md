...
* Creating a Contact Us page so customers can contact your store.
* Adding a form so customers can submit their requests or feedback.
* Handling the data submissions from this contact form to [extend FastStore API with third-party API schemas](https://developers.vtex.com/docs/guides/faststore/api-extensions-extending-api-schema#extending-faststore-api-with-third-party-api-schemas) to handle the form data submission.
...
4. To set up the base structure for your resolver functions, create an `index.ts` file inside the `resolvers` folder.

> ℹ️ For further information on code implementation, see the [`thirdParty`](https://github.com/vtex-sites/playground.store/tree/main/src/graphql/thirdParty) folder available in the [playground.store](https://github.com/vtex-sites/playground.store) repository.

\<CH.Scrollycoding>

### Defining the types

Then, define the GraphQL types for your contact form.
...
> ℹ️ For further information on code implementation, see the [ContactForm](https://github.com/vtex-sites/playground.store/tree/main/src/components/ContactForm) folder available in the [playground.store](https://github.com/vtex-sites/playground.store) repository.
...
> ℹ️ For further information on code implementation, see the `sections.json` file available in the playground.store repository.
> \</CH.Scrollycoding>

### Creating a new landing page

Let’s create a new landing page for the Contact Us page to add the new Contact form section. For this part, follow the [Creating a new page tutorial](https://help.vtex.com/en/tutorial/managing-pages--3DO6rBhZ1p3zndnFu5BgRt#creating-a-new-page).
