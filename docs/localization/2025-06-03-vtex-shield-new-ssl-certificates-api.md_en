...
* GET [List SSL certificates](https://developers.vtex.com/docs/api-reference/ssl-certificates-api#get-/api/edge/certificates): List all custom SSL certificates installed in the store.
