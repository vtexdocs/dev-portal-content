...
Once you have completed all previous steps, [open a ticket with VTEX Support](LINK) at least five days before your planned migration date to request traffic splitting between your main account (FastStore v1) and subaccount (FastStore v3). 
