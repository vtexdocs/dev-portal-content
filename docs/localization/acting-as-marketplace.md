...
When your VTEX store acts as a marketplace and receives products from sellers, you're **acting as a marketplace**. This guide covers the different approaches for integrating sellers into your marketplace.

## Planning your marketplace operation

Before implementing, answer these questions to plan your marketplace operation:

**Seller types:**
- Will you integrate VTEX sellers, external sellers, or both?
- Do you need a seller portal for seller management?
- Do you need franchise accounts for physical stores?

**Catalog management:**
- Who manages product catalogs — sellers or your marketplace team?
- How will you handle product approval and quality control?
- What product information is mandatory for sellers to provide?

**Operations:**
- Who handles order fulfillment — sellers or centralized logistics?
- How will you process payments — collect and distribute, or direct to sellers?
- What commission structure will you use?
- How will you manage seller ratings and reviews?
- Who owns customer service — sellers or the marketplace?

## Types of seller integrations

Your marketplace can integrate with sellers in multiple ways:
...
VTEX can act as an intermediary marketplace between your store and external sellers or marketplaces. In this model, VTEX facilitates connections with certified partners and marketplaces.

**Key characteristics:**
- VTEX acts as a marketplace hub
- Access to VTEX's certified partner network
- Pre-integrated marketplace connections
- Managed integration services

**Best for:** Stores that want to quickly connect to multiple marketplaces through VTEX's network without managing individual integrations.

Learn more in [Marketplace Strategies at VTEX](https://help.vtex.com/en/docs/tutorials/marketplace-strategies-at-vtex).
