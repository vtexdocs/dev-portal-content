...
A [FastStore monorepo](https://developers.vtex.com/docs/guides/faststore/monorepo-overview) can support different storefront modules, such as Product Discovery Experience, Checkout, and Sales App, to meet the merchant's needs.
