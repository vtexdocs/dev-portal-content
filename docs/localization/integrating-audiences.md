...
Audience integration lets you enrich [VTEX Ads](https://developers.vtex.com/docs/guides/vtex-ads) targeting with your own customer data, improving campaign segmentation and ad relevance. It is optional, and recommended for better targeting.
...
> ℹ️ If you do not integrate audiences, open a ticket with [VTEX support](https://help.vtex.com/en/tutorial/how-does-vtex-support-work--2eAT5EyOvaLoHdIWDVaxC3) to request pre-population of segmentation information with base data (`STATE`, `CITY`, `GENDER`, and `AGE`). You can also provide a list of audiences to be registered, and keep them updated periodically.
...
> ℹ️ Before hashing the values, remove all spaces and convert them to lowercase.

> ⚠️ For the `PHONE_HASHED` attribute, format the phone number to the E.164 standard and include the country calling code.
