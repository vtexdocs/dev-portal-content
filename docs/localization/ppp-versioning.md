...
| :---: | :---: | --- |
| `2.0.0` | **[Payment tokenization]([TBD](https://developers.vtex.com/docs/guides/implementing-payments-tokenization))** | Allows you to manage credit card token information, increasing security in the storage and transmission of sensitive payment data. |
