...
| **Multi-language**<br><br>_Native multi-language support via [Messages](https://developers.vtex.com/docs/apps/vtex.messages) and [Admin Catalog Translation](https://developers.vtex.com/docs/apps/vtex.admin-catalog-translation) apps._ | Multi-language support with bindings and locales enables the Messages and Admin Catalog Translation apps to deliver translated storefront text and catalog content from a shared catalog. | Each marketplace account localizes the catalog it receives from the main seller, managing its own languages. | Multi-language support independent per account. |
