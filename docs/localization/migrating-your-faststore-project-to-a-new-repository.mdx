...
>⚠️ For FastStore projects hosted in the `vtex-sites` organization not using WebOps ([FastStore v1](https://v1.faststore.dev/docs)) that you want to migrate to the GitHub organization of the account, see the guide [Migrating from FastStore v1 to v3](LINK).
