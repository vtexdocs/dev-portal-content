...
slug: "2025-10-13-faststore-release-notes-version"
type: "added"
createdAt: "2025-10-13T11:00:00.000Z"
updatedAt: "2025-10-13T11:05:00.000Z"
excerpt: "Version 3.90.0 delivers improvements in analytics tracking, reliable Master Data authentication, faster UI responses, and improved B2B components."
tags:
    - FastStore
---
...
**Improved Analytics tracking in `SearchDropdown` ([\#3057](https://github.com/vtex/faststore/pull/3057))**
...
**Refactored ProductShelf component loading ([\#3059](https://github.com/vtex/faststore/pull/3059))**  
...
**FastStore CLI support for `/pvt` page prefix ([\#3052](https://github.com/vtex/faststore/pull/3052))**  
...
**New My Account components and UI improvements ([\#3040](https://github.com/vtex/faststore/pull/3040))**  
...
**B2B: Organization Drawer displays `corporateName` ([\#3062](https://github.com/vtex/faststore/pull/3062))**
...
**B2B: contract name source updated ([\#3051](https://github.com/vtex/faststore/pull/3051))**  
...
**Removed "Placed by" column from Orders Page ([\#3064](https://github.com/vtex/faststore/pull/3064))**  
...
**App Key/Token authentication for Master Data requests ([\#3055](https://github.com/vtex/faststore/pull/3055))**  
...
**Search Filter Badge visibility ([\#3061](https://github.com/vtex/faststore/pull/3061))**  
...
**Table component responsiveness ([\#3066](https://github.com/vtex/faststore/pull/3066))**  
