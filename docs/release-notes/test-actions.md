...
1. Open a ticket with [VTEX Support](https://help.vtex.com/en/suppor) requesting the account be configured for a single-domain setup. Please include the following information in the ticket:
