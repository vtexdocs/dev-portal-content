...
type: "improved"
excerpt: "VTEX changed how the `availableQuantity` field works, which is returned by the API routes of the VTEX Search (Legacy). This change may impact existing integrations."
