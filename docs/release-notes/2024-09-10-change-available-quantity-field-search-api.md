...
type: "improved"
excerpt: "VTEX changed how the `availableQuantity` field works, which is returned by the API routes of VTEX Search (Legacy). This change may impact existing integrations."
createdAt: "2024-09-10T11:00:00.000Z"
updatedAt: "2024-09-10T11:30:00.000Z"
---

VTEX changed how the `availableQuantity` field works, which is returned by the API routes of VTEX Search (Legacy). This change may impact existing integrations.
