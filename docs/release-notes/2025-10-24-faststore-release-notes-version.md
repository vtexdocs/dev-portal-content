...
excerpt: "Version 3.91.0 improves authentication stability via centralized GraphQL validation and fixes ProductShelf/ProductTiles facets to honor CMS filters and Delivery Promise."
tags:
    - FastStore
---
