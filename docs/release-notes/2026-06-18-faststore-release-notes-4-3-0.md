...
slug: "2026-06-18-faststore-release-notes-4-3-0"
type: added
...
### Password Protection (v4) (PR: [#3276](https://github.com/vtex/faststore/pull/3276))
...
### File upload via Order Entry Service (OES) (PR: [#3334](https://github.com/vtex/faststore/pull/3334))
...
### Sitemap control for CMS landing pages (PR: [#3386](https://github.com/vtex/faststore/pull/3386))
...
### Use authenticator route for set password (PR: [#3380](https://github.com/vtex/faststore/pull/3380))
...
### Propagate upstream error status instead of always 500 (PR: [#3379](https://github.com/vtex/faststore/pull/3379))
...
### Order Entry header authentication fix (PR: [#3395](https://github.com/vtex/faststore/pull/3395))
...
### Migrate Partytown to @qwik.dev (PR: [#3394](https://github.com/vtex/faststore/pull/3394))
