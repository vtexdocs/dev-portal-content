...
FastStore v4 introduces native localization integrated with the [CMS](https://developers.vtex.com/docs/guides/cms-for-faststore-storefronts). This feature enables scalable global storefronts with localized experiences and centralized content management.
...
To start using FastStore v4, you must review and update your project. To do that, follow the instructions in [Upgrading FastStore to v4](https://developers.vtex.com/docs/guides/faststore/getting-started-upgrading-faststore-to-v4).
