...
VTEX clients building new FastStore projects can now install the [FastStore WebOps app](https://developers.vtex.com/docs/guides/faststore/getting-started-2-starting-the-project) directly, eliminating the need to open a ticket for VTEX Support to install it.
