...
[Master Data v2](https://developers.vtex.com/docs/api-reference/master-data-api-v2) now supports declaring which fields in a data entity contain personal data. Configured fields are encrypted, masked by default when retrieved, and automatically participate in data subject request flows, such as the right to be forgotten.
...
This change is opt-in. Existing Master Data v2 entities continue to behave as before until personal data fields are configured.

To start using personal data in a Master Data v2 entity, see the [Managing personal data in Master Data v2](https://developers.vtex.com/docs/guides/managing-personal-data-in-master-data-v2) guide.