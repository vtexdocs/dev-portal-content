...
![not-secure-faststore](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/troubleshooting/checkout-and-shopping-experience/not-secure-faststore.png)
...
4. Check if the `secure` subdomain is pointing to the `secure.{hostname}.cdn.vtex.com`, as in the example below:
   ...
   ![dns-checker](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/docs/troubleshooting/checkout-and-shopping-experience/secure-hostname-2.png)
